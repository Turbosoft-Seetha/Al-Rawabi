...
namespace Merchandising.Admin
{
    public partial class DeliveryCheck : System.Web.UI.Page
    {
        ...
        public void Route()
        {
            ddlRoute.DataSource = ObjclsFrms.loadList("SelectRoute", "sp_Transaction_UOM");
        ...
        {
            ddlCustomer.DataSource = ObjclsFrms.loadList("SelectCustomerByRoute", "sp_Transaction_UOM", routeCondition);
