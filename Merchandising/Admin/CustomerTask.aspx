<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Merchandising.Master" AutoEventWireup="true" CodeBehind="CustomerTask.aspx.cs" Inherits="Merchandising.Admin.CustomerTask" %>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="kt-portlet">
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            ...
                            <div class="kt-subheader__breadcrumbs">
                                ...
                                <a href="CustomerTask.aspx" class="kt-subheader__breadcrumbs">
                    ...
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Customer Task
                            </h3>
                        </div>
                                            ...
                                            <telerik:GridTemplateColumn HeaderStyle-Width="100px" HeaderText="Reference Image" UniqueName="Images" HeaderStyle-Font-Bold="true" AllowFiltering="false">
                                                <ItemTemplate>
                                                    <asp:HyperLink ID="salImg" runat="server" NavigateUrl=' <%#  Eval("cst_ReferenceImage") %>' Target="_blank" Visible="true">
                                                        <asp:Image ID="salImage" runat="server" ImageUrl=' <%#  Eval("cst_ReferenceImage") %>' Height="65px" Visible="true" />
                                                    </asp:HyperLink>
                                                </ItemTemplate>
                                            ...
                                            <telerik:GridTemplateColumn HeaderStyle-Width="100px" HeaderText="Captured Image" UniqueName="Imagess" HeaderStyle-Font-Bold="true" AllowFiltering="false">
                                                <ItemTemplate>
                                                    <asp:HyperLink ID="salImgs" runat="server" NavigateUrl=' <%#  Eval("cst_CapturedImage") %>' Target="_blank" Visible="true">
                                                        <asp:Image ID="salImages" runat="server" ImageUrl=' <%#  Eval("cst_CapturedImage") %>' Height="65px" Visible="true" />
                                                    </asp:HyperLink>
                                                </ItemTemplate>
                                            </telerik:GridTemplateColumn>
