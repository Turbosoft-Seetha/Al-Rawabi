<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Merchandising.Master" AutoEventWireup="true" CodeBehind="ListCustomerBrochure.aspx.cs" Inherits="Merchandising.Admin.ListCustomerBrochure" %>
                        ...
                        <div class="kt-portlet__body">
                            ...
                            <div class="col-lg-12 row">
                                ...
                                <div class="col-lg-4" style="padding-top: 25px;">
                                    <div class="col-lg-12">
                                        <asp:LinkButton ID="LinkButton2" runat="server" CssClass="btn btn-brand btn-elevate btn-icon-sm" Text="Apply Filter" OnClick="LinkButton2_Click"></asp:LinkButton>
                                    </div>
                                </div>
                            </div>
