<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Merchandising.Master" AutoEventWireup="true" CodeBehind="ItemNotAvailableDetail.aspx.cs" Inherits="Merchandising.Admin.ItemNotAvailableDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageHeader" runat="server">
    <script>
        function redirect() {
            ...
            window.location.href = "ItemNotAvailable.aspx";
        }
    </script>
</asp:Content>
                    ...
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            ...
                            <div class="kt-subheader__breadcrumbs">
                                ...
                                <a href="javascript:redirect();" class="kt-subheader__breadcrumbs-link"> Item Not Availabile </a>
                                <span class="kt-subheader__breadcrumbs-separator">></span>
                                <a class="kt-subheader__breadcrumbs-link"> Item Not Availabile Detail </a>
                            </div>
                        </div>
                    </div>
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Item Not Availabile Detail
                            </h3>
                        </div>
