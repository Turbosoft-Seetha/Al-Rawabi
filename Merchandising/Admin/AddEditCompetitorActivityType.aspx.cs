    ...
    public partial class AddEditCompetitorActivityType : System.Web.UI.Page
    {
        ...
        protected void fillForm()
        {
            ...
            else
            {
                ...
                lstData = ObjclsFrms.loadList("SelectCompetitorActivityTypeByID", "sp_Masters", ResponseID.ToString());
        ...
        protected void Save(string mode)
        {
            ...
            if (mode.Equals("I"))
            {
                ...
                DataTable lstClaim = ObjclsFrms.loadList("InsertCompetitorActivityType", "sp_Masters", name.ToString(), arr);
            ...
            else
            {
                ...
                string Value = ObjclsFrms.SaveData("sp_Masters", "UpdateCompetitorActivityType", id.ToString(), arr);
