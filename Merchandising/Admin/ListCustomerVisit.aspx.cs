...
{
    public partial class ListCustomerVisit : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                if (Mode == 1) // While loading page from dashboard 
                {
                    ...
                    RouteFromDashboard();
                    ddlSchedule.SelectedValue = Session["CustomerVisitType"].ToString();
                }
        ...
        public string mainConditions(string rotID)
        {
            ...
            try
            {
                ...
                if (ddlSchedule.SelectedValue.Equals("S"))
                {
                    visitType = " and isnull(ucp_IsScheduled, 'Y') <> 'N'";
                }
                else if (ddlSchedule.SelectedValue.Equals("U"))
                {
                    visitType = " and ucp_IsScheduled = 'N'";
                }
                else
                {
                    visitType = "";
        ...
        public void Data()
        {
            ...
            if (!rotID.Equals("0"))
            {
                ...
                DataTable lstdata = ObjclsFrms.loadList("SelectCustomerVisit", "sp_Transaction", mainCondition);
        ...
        protected void grvRpt_ItemCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
        {
            if (e.CommandName.Equals("Detail"))
            {
                ...
                Response.Redirect("ListCustomerVisitDetail.aspx?Id=" + ID);
            }
        }
        ...
        private void SpreadStreamProcessingForXLSXAndCSV(DataTable dt, SpreadDocumentFormat docFormat = SpreadDocumentFormat.Xlsx, string sheetName = "Sheet1")
        {
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                Response.AppendHeader("Content-Disposition", string.Format("attachment; filename={0}.{1}", "Customer Visit", "Xlsx"));
