...
{
    public partial class ListCustomerCoolerTracking : System.Web.UI.Page
    {
        ...
        public string mainConditions(string rotID)
        {
            ...
            try
            {
                ...
                {
                    customerCondition = " and cct_cus_ID in (" + cusID + ")";
                }
            }
            catch (Exception ex)
            {
        ...
        public void Data()
        {
            ...
            if (!rotID.Equals("0"))
            {
                ...
                DataTable lstdata = ObjclsFrms.loadList("SelectAssetTracking", "sp_Transaction", mainCondition);
        ...
        private void SpreadStreamProcessingForXLSXAndCSV(DataTable dt, SpreadDocumentFormat docFormat = SpreadDocumentFormat.Xlsx, string sheetName = "Sheet1")
        {
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                Response.AppendHeader("Content-Disposition", string.Format("attachment; filename={0}.{1}", "Asset Tracking", "Xlsx"));
        ...
        protected void grvRpt_ItemCommand(object sender, GridCommandEventArgs e)
        {
            if (e.CommandName.Equals("Detail"))
            {
                ...
                Response.Redirect("ListCustomerCoolerTrackingDetail.aspx?Id=" + ID);
            }
        }
    }
}