<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Merchandising.Master" AutoEventWireup="true" CodeBehind="ListCustomerCoolerTracking.aspx.cs" Inherits="Merchandising.Admin.ListCustomerCoolerTracking" %>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Asset Tracking
                            </h3>
                        </div>
                                ...
                                <telerik:RadGrid RenderMode="Lightweight" runat="server" EnableLinqExpressions="false" AllowMultiRowSelection="true"
                                    ...
                                    <MasterTableView AutoGenerateColumns="False" FilterItemStyle-Font-Size="XX-Small" CanRetrieveAllData="false"
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="VisitStart" AllowFiltering="true" HeaderStyle-Width="100px"
                                            ...
                                            <telerik:GridBoundColumn DataField="VisitEnd" AllowFiltering="true" HeaderStyle-Width="100px"
                                            ...
                                            <telerik:GridBoundColumn DataField="clm_Code" AllowFiltering="true" HeaderStyle-Width="100px"
                                                HeaderStyle-Font-Size="Smaller" HeaderText="Assets Code" FilterControlWidth="100%"
                                                CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                                HeaderStyle-Font-Bold="true" UniqueName="clm_Code">
                                            </telerik:GridBoundColumn>

                                            <telerik:GridBoundColumn DataField="clm_Name" AllowFiltering="true" HeaderStyle-Width="120px"
                                                HeaderStyle-Font-Size="Smaller" HeaderText="Assets Name" FilterControlWidth="100%"
                                                CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                                HeaderStyle-Font-Bold="true" UniqueName="clm_Name">
                                            </telerik:GridBoundColumn>
