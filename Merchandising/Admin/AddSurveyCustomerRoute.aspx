<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Merchandising.Master" AutoEventWireup="true" CodeBehind="AddSurveyCustomerRoute.aspx.cs" Inherits="Merchandising.Admin.AddSurveyCustomerRoute" %>
                        ...
                        <div class="col-lg-12 row">
                            <telerik:RadAjaxPanel ID="RadAjaxPanel3" runat="server" LoadingPanelID="RadAjaxLoadingPanel4" Width="70%">
                                <div class="col-lg-9 row">
                                    <div class="col-lg-6" style="padding-top: 15px; padding-bottom: 15px;">
                                        <div class="col-lg-12">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <telerik:RadAjaxPanel ID="rdd" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                        <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btn btn-brand btn-elevate btn-icon-sm" OnClick="lnkAddQuestion_Click">
                                                    Add
                        </asp:LinkButton>
                    </telerik:RadAjaxPanel>
    ...
    <div class="modal fade" id="kt_modal_1_7" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <asp:LinkButton ID="LinkButton2" runat="server" OnClick="btnOK_Click" CssClass="btn btn-secondary">Ok</asp:LinkButton>
                </div>
            </div>
        </div>
    </div>
