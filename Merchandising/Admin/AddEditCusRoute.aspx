<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Merchandising.Master" AutoEventWireup="true" CodeBehind="AddEditCusRoute.aspx.cs" Inherits="Merchandising.Admin.AddEditCusRoute" %>
                        ...
                        <telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                            ...
                            <div class="col-lg-12 row">
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadComboBox ID="ddlcus" runat="server" EmptyMessage="Select Customer" Width="100%" Filter="Contains" RenderMode="Lightweight"></telerik:RadComboBox>
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadDropDownList ID="ddlIsInvoicing" runat="server" Width="100%" emptymessage="Please Select" RenderMode="Lightweight">
                                            <Items>
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadDropDownList ID="ddlIsAR" runat="server" Width="100%" RenderMode="Lightweight">
                                            <Items>
                                                <telerik:DropDownListItem Text="Yes" Value="Y" />
                                                <telerik:DropDownListItem Text="No" Value="N" />
                                            </Items>
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadDropDownList ID="ddIsSOrder" runat="server" Width="100%" RenderMode="Lightweight">
                                            <Items>
                                                <telerik:DropDownListItem Text="Yes" Value="Y" />
                                                <telerik:DropDownListItem Text="No" Value="N" />
                                            </Items>
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadDropDownList ID="ddIsMerchand" runat="server" Width="100%" RenderMode="Lightweight">
                                            <Items>
                                                <telerik:DropDownListItem Text="Yes" Value="Y" />
                                                <telerik:DropDownListItem Text="No" Value="N" />
                                            </Items>
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadDropDownList ID="ddIsI_Sales" runat="server" Width="100%" RenderMode="Lightweight">
                                            <Items>
                                                <telerik:DropDownListItem Text="Yes" Value="Y" />
                                                <telerik:DropDownListItem Text="No" Value="N" />
                                            </Items>
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadDropDownList ID="ddIsI_GR" runat="server" Width="100%" RenderMode="Lightweight">
                                            <Items>
                                                <telerik:DropDownListItem Text="Yes" Value="Y" />
                                                <telerik:DropDownListItem Text="No" Value="N" />
                                            </Items>
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadDropDownList ID="ddIsI_BR" runat="server" Width="100%" RenderMode="Lightweight">
                                            <Items>
                                                <telerik:DropDownListItem Text="Yes" Value="Y" />
                                                <telerik:DropDownListItem Text="No" Value="N" />
                                            </Items>
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadDropDownList ID="ddIsI_FG" runat="server" Width="100%" RenderMode="Lightweight">
                                            <Items>
                                                <telerik:DropDownListItem Text="Yes" Value="Y" />
                                                <telerik:DropDownListItem Text="No" Value="N" />
                                            </Items>
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadNumericTextBox ID="txtTCL" runat="server" CssClass="form-control" Width="100%" Enabled="true" RenderMode="Lightweight"></telerik:RadNumericTextBox>
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadNumericTextBox ID="txtUCL" runat="server" CssClass="form-control" Width="100%" Enabled="true" RenderMode="Lightweight"></telerik:RadNumericTextBox>
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadNumericTextBox ID="txtCDays" runat="server" CssClass="form-control" Width="100%" Enabled="true" RenderMode="Lightweight"></telerik:RadNumericTextBox>
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadDropDownList ID="ddVoidEnable" runat="server" Width="100%" RenderMode="Lightweight">
                                            <Items>
                                                <telerik:DropDownListItem Text="Yes" Value="Y" />
                                                <telerik:DropDownListItem Text="No" Value="N" />
                                            </Items>
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadDropDownList ID="ddEditEnable" runat="server" Width="100%" RenderMode="Lightweight">
                                            <Items>
                                                <telerik:DropDownListItem Text="Yes" Value="Y" />
                                                <telerik:DropDownListItem Text="No" Value="N" />
                                            </Items>
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadDropDownList ID="ddSE" runat="server" Width="100%" RenderMode="Lightweight">
                                            <Items>
                                                <telerik:DropDownListItem Text="Yes" Value="Y" />
                                                <telerik:DropDownListItem Text="No" Value="N" />
                                            </Items>
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadDropDownList ID="ddPT" runat="server" Width="100%" RenderMode="Lightweight">
                                            <Items>
                                                <telerik:DropDownListItem Text="Yes" Value="Y" />
                                                <telerik:DropDownListItem Text="No" Value="N" />
                                            </Items>
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadDropDownList ID="ddSign" runat="server" Width="100%" RenderMode="Lightweight">
                                            <Items>
                                                <telerik:DropDownListItem Text="Yes" Value="Y" />
                                                <telerik:DropDownListItem Text="No" Value="N" />
                                            </Items>
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadDropDownList ID="ddRoundAmount" runat="server" Width="100%" RenderMode="Lightweight">
                                            <Items>
                                                <telerik:DropDownListItem Text="Yes" Value="Y" />
                                                <telerik:DropDownListItem Text="No" Value="N" />
                                            </Items>
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadDropDownList ID="ddIsVAT" runat="server" Width="100%" RenderMode="Lightweight">
                                            <Items>
                                                <telerik:DropDownListItem Text="Yes" Value="Y" />
                                                <telerik:DropDownListItem Text="No" Value="N" />
                                            </Items>
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadDropDownList ID="ddIsID" runat="server" Width="100%" RenderMode="Lightweight">
                                            <Items>
                                                <telerik:DropDownListItem Text="Yes" Value="Y" />
                                                <telerik:DropDownListItem Text="No" Value="N" />
                                            </Items>
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadDropDownList ID="ddIsPO" runat="server" Width="100%" RenderMode="Lightweight">
                                            <Items>
                                                <telerik:DropDownListItem Text="Yes" Value="Y" />
                                                <telerik:DropDownListItem Text="No" Value="N" />
                                            </Items>
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadDropDownList ID="ddcusType" runat="server" Width="100%" RenderMode="Lightweight">
                                            <Items>
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadNumericTextBox ID="txtACL" runat="server" CssClass="form-control" Width="100%" Enabled="true" RenderMode="Lightweight"></telerik:RadNumericTextBox>
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadDropDownList ID="ddlSI" runat="server" Width="100%" RenderMode="Lightweight">
                                            <Items>
                                                <telerik:DropDownListItem Text="Yes" Value="Y" />
                                                <telerik:DropDownListItem Text="No" Value="N" />
                                            </Items>
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadDropDownList ID="ddRe" runat="server" Width="100%" RenderMode="Lightweight">
                                            <Items>
                                                <telerik:DropDownListItem Text="Yes" Value="Y" />
                                                <telerik:DropDownListItem Text="No" Value="N" />
                                            </Items>
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadDropDownList ID="ddRAR" runat="server" Width="100%" RenderMode="Lightweight">
                                            <Items>
                                                <telerik:DropDownListItem Text="Yes" Value="Y" />
                                                <telerik:DropDownListItem Text="No" Value="N" />
                                            </Items>
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadDropDownList ID="ddROQ" runat="server" Width="100%" RenderMode="Lightweight">
                                            <Items>
                                                <telerik:DropDownListItem Text="Yes" Value="Y" />
                                                <telerik:DropDownListItem Text="No" Value="N" />
                                            </Items>
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadNumericTextBox ID="txtinv" runat="server" CssClass="form-control" Width="100%" Enabled="true" RenderMode="Lightweight"></telerik:RadNumericTextBox>
