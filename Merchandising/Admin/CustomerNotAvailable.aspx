<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Merchandising.Master" AutoEventWireup="true" CodeBehind="CustomerNotAvailable.aspx.cs" Inherits="Merchandising.Admin.CustomerNotAvailable" %>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="kt-portlet">
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            ...
                            <div class="kt-subheader__breadcrumbs">
                                ...
                                <a class="kt-subheader__breadcrumbs-link"> Customer Not Availabile </a>
                    ...
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Customer Not Available
                            </h3>
                        </div>
