...
namespace Merchandising.Admin
{
    public partial class ItemNotAvailable : System.Web.UI.Page
    {
        ...
        public void ListData()
        {
            ...
            lstUser = ObjclsFrms.loadList("SelectItemNotAvailable", "sp_Report", mainCondition);
        ...
        protected void grvRpt_ItemCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
        {
            if (e.CommandName.Equals("Detail"))
            {
                ...
                string ID = dataItem.GetDataKeyValue("iad_itm_ID").ToString();
        ...
        private void SpreadStreamProcessingForXLSXAndCSV(DataTable dt, SpreadDocumentFormat docFormat = SpreadDocumentFormat.Xlsx, string sheetName = "Sheet1")
        {
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                Response.AppendHeader("Content-Disposition", string.Format("attachment; filename={0}.{1}", "Item Not Available", "Xlsx"));
