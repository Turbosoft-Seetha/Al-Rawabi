<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Merchandising.Master" AutoEventWireup="true" CodeBehind="ListAfterMerchImages.aspx.cs" Inherits="Merchandising.Admin.ListAfterMerchImages" %>
                ...
                <div class="kt-portlet">
                    <div class="kt-portlet__head" style="padding-top: 20px">
                        ...
                        <div class="kt-subheader__breadcrumbs">
                            ...
                            <a href="ListAfterMerchImages.aspx" class="kt-subheader__breadcrumbs">
                                <i class="flaticon2-shelter"></i> Final Image Captures </a>
                    ...
                    <div class="kt-portlet__head" style="padding-top: 20px; padding-bottom: 20px;">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Final Image Captures
                            </h3>
                        </div>
                                ...
                                <telerik:RadGrid RenderMode="Lightweight" runat="server" EnableLinqExpressions="false" AllowMultiRowSelection="false"
                                    ...
                                    <MasterTableView AutoGenerateColumns="False" FilterItemStyle-Font-Size="XX-Small" CanRetrieveAllData="false"
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridTemplateColumn HeaderStyle-Width="150px" HeaderText="Uploaded Images" UniqueName="Images" HeaderStyle-Font-Bold="true" AllowFiltering="false" HeaderStyle-Font-Size="Smaller">
                                                <ItemTemplate>
