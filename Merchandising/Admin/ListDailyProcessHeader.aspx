<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Merchandising.Master" AutoEventWireup="true" CodeBehind="ListDailyProcessHeader.aspx.cs" Inherits="Merchandising.Admin.ListDailyProcessHeader" %>
                ...
                <div class="kt-portlet">
                    <div class="kt-portlet__head" style="padding-top: 20px">
                        ...
                        <div class="kt-subheader__breadcrumbs">
                            ...
                            <a href="ListDailyProcessHeader.aspx" class="kt-subheader__breadcrumbs">
                                <i class="flaticon2-shelter"></i> Daily User-Route Process </a>
                    ...
                    <div class="kt-portlet__head" style="padding-top: 20px; padding-bottom: 20px;">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Daily User-Route Process
                            </h3>
                        </div>
                                ...
                                <telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel2">
                                    <div class="col-lg-12 row" style="padding-bottom: 30px;">
                                        ...
                                        <div class="col-lg-4" style="padding-top: 8px;">
                                            ...
                                            <div class="col-lg-12">
                                                <telerik:RadComboBox ID="ddlRoute" runat="server" Filter="Contains" RenderMode="Lightweight" AutoPostBack="true" EmptyMessage="Select Route" Width="100%">
                                                </telerik:RadComboBox>
                                            </div>
                                        </div>
                            ...
                            <telerik:RadGrid RenderMode="Lightweight" runat="server" EnableLinqExpressions="false" AllowMultiRowSelection="false"
                                ...
                                <MasterTableView AutoGenerateColumns="False" FilterItemStyle-Font-Size="XX-Small" CanRetrieveAllData="false"
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridDateTimeColumn DataField="dph_Date" AllowFiltering="true" HeaderStyle-Width="60px"
                                            ...
                                            HeaderStyle-Font-Bold="true" UniqueName="dph_Date" DataType="System.DateTime" FilterDateFormat="dd-MMM-yyyy">
                                        </telerik:GridDateTimeColumn>

                                        <telerik:GridBoundColumn DataField="dph_StartDay" AllowFiltering="true" HeaderStyle-Width="60px"
                                            ...
                                            HeaderStyle-Font-Bold="true" UniqueName="dph_StartDay">
                                        </telerik:GridBoundColumn>

                                        <telerik:GridBoundColumn DataField="dph_StartDayTime" AllowFiltering="true" HeaderStyle-Width="60px"
                                            HeaderStyle-Font-Size="Smaller" HeaderText="Start Day Time" FilterControlWidth="100%"
                                            CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                            HeaderStyle-Font-Bold="true" UniqueName="dph_StartDayTime">
                                        </telerik:GridBoundColumn>

                                        <telerik:GridBoundColumn DataField="dph_EndDay" AllowFiltering="true" HeaderStyle-Width="60px"
                                            HeaderStyle-Font-Size="Smaller" HeaderText="End Day" FilterControlWidth="100%"
                                            CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false" Visible="false"
                                            HeaderStyle-Font-Bold="true" UniqueName="dph_EndDay">
                                        </telerik:GridBoundColumn>

                                        <telerik:GridBoundColumn DataField="dph_EndDayTime" AllowFiltering="true" HeaderStyle-Width="60px"
                                            HeaderStyle-Font-Size="Smaller" HeaderText="End Day Time" FilterControlWidth="100%"
                                            CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                            HeaderStyle-Font-Bold="true" UniqueName="dph_EndDayTime">
                                        </telerik:GridBoundColumn>

                                        <telerik:GridBoundColumn DataField="dph_VersionNumber" AllowFiltering="true" HeaderStyle-Width="60px"
                                            HeaderStyle-Font-Size="Smaller" HeaderText="App Version" FilterControlWidth="100%"
                                            CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
