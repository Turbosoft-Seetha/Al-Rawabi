...
{
    public partial class SalesWeekCalender : System.Web.UI.Page
    {
        ...
        {
            DataTable lstData = ObjclsFrms.loadList("SelectSalesWeekCalender", "sp_Masters", year.ToString());
            grvRpt.DataSource = lstData;
        }

        protected void ddlYear_SelectedIndexChanged(object sender, Telerik.Web.UI.RadComboBoxSelectedIndexChangedEventArgs e)
        {
        ...
        private void SpreadStreamProcessingForXLSXAndCSV(DataTable dt, SpreadDocumentFormat docFormat = SpreadDocumentFormat.Xlsx, string sheetName = "Sheet1")
        {
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                Response.AppendHeader("Content-Disposition", string.Format("attachment; filename={0}.{1}", "Sales Week Calender", "Xlsx"));
