    ...
    public partial class AddEditCompetitor : System.Web.UI.Page
    {
        ...
        protected void fillForm()
        {
            ...
            else
            {
                ...
                lstData = ObjclsFrms.loadList("SelectCompetitorByID", "sp_Masters", ResponseID.ToString());
        ...
        protected void Save(string mode)
        {
            ...
            if (mode.Equals("I"))
            {
                ...
                DataTable lstClaim = ObjclsFrms.loadList("InsertCompetitor", "sp_Masters", name.ToString(), arr);
            ...
            else
            {
                ...
                string Value = ObjclsFrms.SaveData("sp_Masters", "UpdateCompetitor", id.ToString(), arr);
