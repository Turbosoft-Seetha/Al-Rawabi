    ...
    public partial class ListCustomerRetailPrice : System.Web.UI.Page
    {
        ...
        public void ListData()
        {
            ...
            if (!rotID.Equals("0"))
            {
                ...
                DataTable lstdata = ObjclsFrms.loadList("SelectItemPricing", "sp_Transaction", mainCondition);
        ...
        private void SpreadStreamProcessingForXLSXAndCSV(DataTable dt, SpreadDocumentFormat docFormat = SpreadDocumentFormat.Xlsx, string sheetName = "Sheet1")
        {
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                Response.AppendHeader("Content-Disposition", string.Format("attachment; filename={0}.{1}", "Item Pricing", "Xlsx"));
