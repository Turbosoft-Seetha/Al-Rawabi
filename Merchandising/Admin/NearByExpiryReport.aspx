<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Merchandising.Master" AutoEventWireup="true" CodeBehind="NearByExpiryReport.aspx.cs" Inherits="Merchandising.Admin.NearByExpiryReport" %>
                    ...
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            ...
                            <div class="kt-subheader__breadcrumbs">
                                ...
                                <a href="NearByExpiryReport.aspx" class="kt-subheader__breadcrumbs">
                                    <i class="flaticon2-shelter"></i> Near By Expiry Report </a>
                            </div>
                        </div>
                    </div>
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Near By Expiry Report</h3>
                        </div>
                                ...
                                <telerik:RadGrid RenderMode="Lightweight" runat="server" EnableLinqExpressions="false" AllowMultiRowSelection="false"
                                    ...
                                    <MasterTableView AutoGenerateColumns="False" FilterItemStyle-Font-Size="XX-Small" CanRetrieveAllData="false"
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="ihd_BatchCode" AllowFiltering="true" HeaderStyle-Width="100px"
                                            ...
                                            <telerik:GridBoundColumn DataField="ihd_ExpiryDate" AllowFiltering="true" HeaderStyle-Width="110px"
                                            ...
                                            <telerik:GridBoundColumn DataField="ihd_HQty" AllowFiltering="true" HeaderStyle-Width="80px"
                                                HeaderStyle-Font-Size="Smaller" HeaderText="Higher Qty" FilterControlWidth="100%"
                                                CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                                HeaderStyle-Font-Bold="true" UniqueName="ihd_HQty">
                                            </telerik:GridBoundColumn>

                                            <telerik:GridBoundColumn DataField="ihd_LQty" AllowFiltering="true" HeaderStyle-Width="80px"
                                                HeaderStyle-Font-Size="Smaller" HeaderText="Lower Qty" FilterControlWidth="100%"
                                                CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                                HeaderStyle-Font-Bold="true" UniqueName="ihd_LQty">
                                            </telerik:GridBoundColumn>

                                            <%--<telerik:GridBoundColumn DataField="ihd_TotalQty" AllowFiltering="true" HeaderStyle-Width="80px"
                                                HeaderStyle-Font-Size="Smaller" HeaderText="Total Qty" FilterControlWidth="100%"
                                                CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                                HeaderStyle-Font-Bold="true" UniqueName="ihd_TotalQty">
                                            </telerik:GridBoundColumn>--%>
