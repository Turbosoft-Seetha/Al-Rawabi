<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Merchandising.Master" AutoEventWireup="true" CodeBehind="ListCustomerRetailPriceDetail.aspx.cs" Inherits="Merchandising.Admin.ListCustomerRetailPriceDetail" %>
                        ...
                        <div class="kt-portlet__head-label">
                            ...
                            <div class="kt-subheader__breadcrumbs">
                                <a href="ListCustomerRetailPrice.aspx" class="kt-subheader__breadcrumbs">
                                    <i class="flaticon2-shelter"></i> Item Pricing </a>
                                <span class="kt-subheader__breadcrumbs-separator">></span>
                                <a class="kt-subheader__breadcrumbs-link"> Item Pricing Detail </a>
                            </div>
                        </div>
                    </div>
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Item Pricing Detail
                            </h3>
                        </div>
