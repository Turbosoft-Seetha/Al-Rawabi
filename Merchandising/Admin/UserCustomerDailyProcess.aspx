<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Merchandising.Master" AutoEventWireup="true" CodeBehind="UserCustomerDailyProcess.aspx.cs" Inherits="Merchandising.Admin.UserCustomerDailyProcess" %>
                ...
                <div class="kt-portlet">
                    <div class="kt-portlet__head" style="padding-top: 20px">
                        ...
                        <div class="kt-subheader__breadcrumbs">
                            ...
                            <a href="UserCustomerDailyProcess.aspx" class="kt-subheader__breadcrumbs">
                                <i class="flaticon2-shelter"></i> User Customer Daily Process </a>
                    ...
                    <div class="kt-portlet__head" style="padding-top: 20px; padding-bottom: 20px;">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">User Customer Daily Process
                            </h3>
                        </div>
                                ...
                                <MasterTableView AutoGenerateColumns="False" FilterItemStyle-Font-Size="XX-Small" CanRetrieveAllData="false"
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="dph_Time" AllowFiltering="true" HeaderStyle-Width="60px"
                                            ...
                                            CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                            HeaderStyle-Font-Bold="true" UniqueName="dph_Time" Visible="false">
                                        </telerik:GridBoundColumn>

                                        <telerik:GridBoundColumn DataField="ucp_CusStart" AllowFiltering="true" HeaderStyle-Width="60px"
                                            ...
                                            HeaderStyle-Font-Bold="true" UniqueName="ucp_CusStart">
                                        </telerik:GridBoundColumn>

                                        <telerik:GridBoundColumn DataField="ucp_CusStartTime" AllowFiltering="true" HeaderStyle-Width="60px"
                                        ...
                                        <telerik:GridBoundColumn DataField="ucp_CusExit" AllowFiltering="true" HeaderStyle-Width="60px"
                                            HeaderStyle-Font-Size="Smaller" HeaderText="Customer End" FilterControlWidth="100%"
                                            CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false" Visible="false"
                                            HeaderStyle-Font-Bold="true" UniqueName="ucp_CusExit">
                                        </telerik:GridBoundColumn>

                                        <telerik:GridBoundColumn DataField="ucp_CusEndTime" AllowFiltering="true" HeaderStyle-Width="60px"
                                        ...
                                        <telerik:GridBoundColumn DataField="ucp_Duration" AllowFiltering="true" HeaderStyle-Width="60px"
                                            HeaderStyle-Font-Size="Smaller" HeaderText="Duration" FilterControlWidth="100%"
                                            CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                            HeaderStyle-Font-Bold="true" UniqueName="ucp_Duration">
                                        </telerik:GridBoundColumn>
