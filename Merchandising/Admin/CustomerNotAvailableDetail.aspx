<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Merchandising.Master" AutoEventWireup="true" CodeBehind="CustomerNotAvailableDetail.aspx.cs" Inherits="Merchandising.Admin.CustomerNotAvailableDetail" %>
<%@ Register TagPrefix="telerik" Namespace="Telerik.Web.UI" Assembly="Telerik.Web.UI" %>
<asp:Content ID="Content1" ContentPlaceHolderID="PageHeader" runat="server">
    <script>
        function redirect() {
            var url = new URL(window.location.href);
            window.location.href = "CustomerNotAvailable.aspx";
        }
    </script>
</asp:Content>
                    ...
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            ...
                            <div class="kt-subheader__breadcrumbs">
                                ...
                                <a href="javascript:redirect();" class="kt-subheader__breadcrumbs-link"> Customer Not Availabile </a>
                                <span class="kt-subheader__breadcrumbs-separator">></span>
                                <a class="kt-subheader__breadcrumbs-link"> Customer Not Availabile Detail </a>
                            </div>
                        </div>
                    </div>
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Customer Not Availabile Detail
                            </h3>
                        </div>
