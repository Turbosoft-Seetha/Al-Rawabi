<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Merchandising.Master" AutoEventWireup="true" CodeBehind="DetailedDailyTransactions.aspx.cs" Inherits="Merchandising.Admin.DetailedDailyTransactions" %>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Customer Operations - <asp:Label ID="lblType" runat="server" Font-Bold="true" ForeColor="Blue"></asp:Label>
                            </h3>
                        </div>
                                    ...
                                    <MasterTableView AutoGenerateColumns="true" FilterItemStyle-Font-Size="XX-Small" CanRetrieveAllData="false"
                                        ...
                                        <Columns>
                                         ...
                                         <telerik:GridTemplateColumn HeaderStyle-Width="100px" HeaderText="Attachment" UniqueName="Images" HeaderStyle-Font-Bold="true" AllowFiltering="false">
                                                <ItemTemplate>
                                                    <asp:HyperLink ID="salImg" runat="server" NavigateUrl=' <%#  Eval("image") %>' Target="_blank" Visible="false">
                                                        <asp:Image ID="salImage" runat="server" ImageUrl=' <%#  Eval("image") %>' Height="65px" Visible="true" />
                                                    </asp:HyperLink>
                                                </ItemTemplate>
                                            </telerik:GridTemplateColumn>

                                            <telerik:GridTemplateColumn HeaderStyle-Width="100px" HeaderText="Attachment 2" UniqueName="Imagess" HeaderStyle-Font-Bold="true" AllowFiltering="false">
                                                <ItemTemplate>
                                                    <asp:HyperLink ID="salImgs" runat="server" NavigateUrl=' <%#  Eval("attachment") %>' Target="_blank" Visible="true" ImageUrl="assets/media/icons/svg/Files/File.svg">
                                                        <asp:Image ID="salImages" runat="server" ImageUrl=' <%#  Eval("attachment") %>' Height="65px" Visible="true" />
                                                    </asp:HyperLink>
                                                </ItemTemplate>
                                            </telerik:GridTemplateColumn>

                                            <telerik:GridBoundColumn DataField="image" AllowFiltering="true" HeaderStyle-Width="100px" Visible="false"
                                                HeaderStyle-Font-Size="Smaller" HeaderText="" FilterControlWidth="100%"
                                                CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                                HeaderStyle-Font-Bold="true" UniqueName="imag">
