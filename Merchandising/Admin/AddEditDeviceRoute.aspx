<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Merchandising.Master" AutoEventWireup="true" CodeBehind="AddEditDeviceRoute.aspx.cs" Inherits="Merchandising.Admin.AddEditDeviceRoute" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageHeader" runat="server">
    <script>
        ...
        function redirect() {
            ...
            window.location.href = "DeviceRoute.aspx?Id=" + c;
        }
    </script>
</asp:Content>
                ...
                <div class="kt-portlet">
                    <div class="kt-portlet__head" style="padding-top: 20px">
                        ...
                        <div class="kt-subheader__breadcrumbs">
                            ...
                            <a href="javascript:redirect();" class="kt-subheader__breadcrumbs-link"> Device Route </a>
                            <span class="kt-subheader__breadcrumbs-separator">></span>
                            <a class="kt-subheader__breadcrumbs-link"> Add Edit Device </a>
                    ...
                    <div class="kt-portlet__head" style="padding-top: 20px; padding-bottom: 20px;">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Add Edit Device
                            </h3>
                        </div>
                    ...
                    <div class="kt-portlet__body">
                        <div class="col-lg-12 row">
                            ...
                            <div class="col-lg-4 form-group" style="padding-bottom: 15px;">
                                <label class="control-label col-lg-12">MAC ID <span class="required">* </span></label>
                                <div class="col-lg-12">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ValidationGroup="form"
                                        ControlToValidate="txtName" ErrorMessage="Please Enter MAC ID" Display="Dynamic" ForeColor="Red"
                                        SetFocusOnError="True"></asp:RequiredFieldValidator>
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ForeColor="Red" Display="Dynamic"
                                        ValidationExpression="^([0-9A-Fa-f]{2}[:-]){5}([0-9A-Fa-f]{2})$" ControlToValidate="txtName"
                                        ErrorMessage="Please enter valid MAC ID"></asp:RegularExpressionValidator>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 form-group" style="padding-bottom: 15px;">
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadTextBox ID="txtRoute" runat="server" CssClass="form-control" Width="100%" Enabled="false"></telerik:RadTextBox>
                                </div>
                            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <span>Device has been updated successfully.</span>
                </div>
                <div class="modal-footer">
