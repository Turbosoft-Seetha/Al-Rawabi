...
namespace Merchandising.Admin
{
    public partial class AddSurveyDetail : System.Web.UI.Page
    {
        ...
        protected void fillForm()
        {
            ...
            lstData = Obj.loadList("SelectSurveyMasterById", "sp_Survey", ResponseID.ToString());
        ...
        {
            DataTable dt = Obj.loadList("SelectQuestions", "sp_Survey", ResponseID.ToString());
        ...
        protected void Save()
        {
            ...
            string Value = Obj.SaveData("sp_Survey", "AddSurveyDetail", ResponseID.ToString(), arr);
        ...
        public void LoadData()
        {
            ...
            lstDatas = Obj.loadList("SelectSurveyDetailsById", "sp_Survey", ResponseID.ToString());
        ...
        public void Delete()
        {
            ...
            Obj.loadList("Delete", "sp_Survey", dID.ToString());
            grvRpt.DataBind();
        }
