    ...
    public partial class Reports : System.Web.UI.Page
    {
        ...
        protected void grvRpt_ItemCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            if (e.CommandName.Equals("map"))
            {
                GridDataItem dataItem = e.Item as GridDataItem;
                string id = dataItem.GetDataKeyValue("dph_ID").ToString();
                OpenNewBrowserWindow("https://track.dev-ts.online/Home/ViewMap?Id=" + id + "&&mode=DIGITS-MER", this);
            }
        }
        ...
        protected void ImageButton4_Click(object sender, ImageClickEventArgs e)
        {
            ...
            foreach (GridColumn column in grvRpt.MasterTableView.Columns)
            {
                if (!string.IsNullOrEmpty(column.UniqueName) && !string.IsNullOrEmpty(column.HeaderText))
                {
                    ...
                    {
                        if (column.ColumnGroupName.Contains("Downloadable"))
                        {
                            columncount++;
        ...
        private void SpreadStreamProcessingForXLSXAndCSV(DataTable dt, SpreadDocumentFormat docFormat = SpreadDocumentFormat.Xlsx, string sheetName = "Sheet1")
        {
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                Response.AppendHeader("Content-Disposition", string.Format("attachment; filename={0}.{1}", "User Daily Process Report", "Xlsx"));
