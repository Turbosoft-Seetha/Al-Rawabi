<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Merchandising.Master" AutoEventWireup="true" CodeBehind="AddEditUsers.aspx.cs" Inherits="Merchandising.Admin.AddEditUsers" %>
                    ...
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            ...
                            <div class="kt-subheader__breadcrumbs">
                                <a href="ListUser.aspx" class="kt-subheader__breadcrumbs">
                                    <i class="flaticon2-shelter"></i> App Users </a>
                                <%--<span class="kt-subheader__breadcrumbs-separator">></span>
                            <a href="javascript:redirect();" class="kt-subheader__breadcrumbs-link">Users </a>--%>
                                <span class="kt-subheader__breadcrumbs-separator">></span>
                                <a class="kt-subheader__breadcrumbs-link"> Add Edit App Users </a>
                            </div>
                        </div>
                    </div>
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Add Edit App Users
                            </h3>
                        </div>
                        <div class="kt-portlet__head-actions" style="padding-top: 10px;">
                            <telerik:RadAjaxPanel ID="pnl" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                                ...
                                &nbsp;
                                    <a class="btn btn-brand btn-elevate btn-icon-sm" href="ListUser.aspx">Cancel
                                    </a>
                    ...
                    <div class="kt-portlet__body">
                        <div class="col-lg-12 row">
                            ...
                            <div class="col-lg-4 form-group" style="padding-bottom: 15px;">
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadNumericTextBox ID="txtTrDuration" runat="server" CssClass="form-control" Width="100%" RenderMode="Lightweight"></telerik:RadNumericTextBox>
