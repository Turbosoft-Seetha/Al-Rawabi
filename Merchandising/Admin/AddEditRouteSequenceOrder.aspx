<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Merchandising.Master" AutoEventWireup="true" CodeBehind="AddEditRouteSequenceOrder.aspx.cs" Inherits="Merchandising.Admin.AddEditRouteSequenceOrder" %>
                ...
                <div class="kt-portlet">
                    <div class="kt-portlet__head" style="padding-top: 20px">
                        ...
                        <div class="kt-subheader__breadcrumbs">
                            ...
                            <a href="ListRouteSequenceOrder.aspx" class="kt-subheader__breadcrumbs">
                                <i class="flaticon2-shelter"></i> Route Sequence Order </a>
                            <%--<span class="kt-subheader__breadcrumbs-separator">></span>
                            <a href="javascript:redirect();" class="kt-subheader__breadcrumbs-link">Users </a>--%>
                            <span class="kt-subheader__breadcrumbs-separator">></span>
                            <a class="kt-subheader__breadcrumbs-link"> Add Edit Route Sequence Order </a>
                    ...
                    <div class="kt-portlet__head" style="padding-top: 20px; padding-bottom: 20px;">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Add Edit Route Sequence Order
                            </h3>
                        </div>
                        <div class="kt-portlet__head-actions">
                            <telerik:RadAjaxPanel ID="pnl" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                                ...
                                &nbsp;
                                    <a class="btn btn-brand btn-elevate btn-icon-sm" href="ListRouteSequenceOrder.aspx">Cancel
                                    </a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <span>Route sequence order has been updated successfully.</span>
                </div>
                <div class="modal-footer">
