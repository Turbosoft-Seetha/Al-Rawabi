<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Merchandising.Master" AutoEventWireup="true" CodeBehind="AddEditCoolerType.aspx.cs" Inherits="Merchandising.Admin.AddEditCoolerType" %>
                    ...
                    <div class="kt-portlet__head">
                        ...
                        <div class="kt-portlet__head-actions" style="padding-top: 10px;">
                            <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                                ...
                                &nbsp;
                                    <a class="btn btn-brand btn-elevate btn-icon-sm" href="ListCoolerType.aspx">Cancel
                                    </a>
                    ...
                    <div class="kt-portlet__body">
                        <div class="col-lg-12 row">
                            ...
                            <div class="col-lg-4 form-group" style="padding-bottom: 15px;">
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadTextBox ID="txtCapacity" runat="server" CssClass="form-control" Width="100%" RenderMode="Lightweight"></telerik:RadTextBox>
                            ...
                            <div class="col-lg-4 form-group" style="padding-bottom: 15px;">
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadTextBox ID="txtPlanogram" runat="server" CssClass="form-control" Width="100%" TextMode="MultiLine" Rows="5" RenderMode="Lightweight"></telerik:RadTextBox>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <span>Cooler type has been updated successfully.</span>
                </div>
                <div class="modal-footer">
