...
namespace Merchandising.Admin
{
    public partial class Inventory : System.Web.UI.Page
    {
        ...
        public void Route()
        {
            ddlRoute.DataSource = ObjclsFrms.loadList("SelectRoute", "sp_Masters_Temp");
        ...
        {
            ddlCustomer.DataSource = ObjclsFrms.loadList("SelectCustomerByRoute", "sp_Masters_Temp", routeCondition);
        ...
        public void Data()
        {
            ...
            if (!rotID.Equals("0"))
            {
                ...
                DataTable lstdata = ObjclsFrms.loadList("SelectInventory", "sp_Masters_Temp", mainCondition);
        ...
        private void SpreadStreamProcessingForXLSXAndCSV(DataTable dt, SpreadDocumentFormat docFormat = SpreadDocumentFormat.Xlsx, string sheetName = "Sheet1")
        {
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                Response.AppendHeader("Content-Disposition", string.Format("attachment; filename={0}.{1}", "Customer Inventory", "Xlsx"));
