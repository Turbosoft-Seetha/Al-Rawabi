<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Merchandising.Master" AutoEventWireup="true" CodeBehind="AddEditCoolerMaster.aspx.cs" Inherits="Merchandising.Admin.AddEditCoolerMaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageHeader" runat="server">
    <script>
        ...
        function redirect() {
            ...
            window.location.href = "ListCoolerMaster.aspx?Id=" + c;
        }
                    ...
                    <div class="kt-portlet__head">
                        ...
                        <div class="kt-portlet__head-actions" style="padding-top: 10px;">
                            <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                                ...
                                &nbsp;
                                <asp:LinkButton ID="lnkCancel" runat="server" CssClass="btn btn-brand btn-elevate btn-icon-sm" Text="Cancel" OnClick="lnkCancel_Click"></asp:LinkButton>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <span>Cooler master has been updated successfully.</span>
                </div>
                <div class="modal-footer">
