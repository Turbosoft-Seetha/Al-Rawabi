    ...
    public partial class AddEditArea : System.Web.UI.Page
    {
        ...
        protected void Save()
        {
            ...
            if (ResponseID.Equals("") || ResponseID == 0)
            {
                ...
                string Value = ObjclsFrms.SaveData("sp_Masters_Temp", "InsertIntoArea", name.ToString(), arr);
            ...
            else
            {
                ...
                string Value = ObjclsFrms.SaveData("sp_Masters_Temp", "UpdateArea", name.ToString(), arr);
                int res = Int32.Parse(Value.ToString());
                if (res > 0)
