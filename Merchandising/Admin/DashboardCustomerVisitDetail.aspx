<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Merchandising.Master" AutoEventWireup="true" CodeBehind="DashboardCustomerVisitDetail.aspx.cs" Inherits="Merchandising.Admin.DashboardCustomerVisitDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageHeader" runat="server">
    <script>
        function redirect() {
            ...
            window.location.href = "DashboardDetail.aspx?Type=" + c;
        }
    </script>
</asp:Content>
                ...
                <div class="kt-portlet">
                    <div class="kt-portlet__head" style="padding-top: 20px">
                        ...
                        <div class="kt-subheader__breadcrumbs">
                            ...
                            <a href="javascript:redirect();" class="kt-subheader__breadcrumbs-link"> Visit Detail </a>
                            <span class="kt-subheader__breadcrumbs-separator">></span>
                                            ...
                                            <div class="kt-portlet__body" style="background-color: #F9FAFC; display: grid;">
                                                <table>
                                                    ...
                                                    <td style="width: 56%">
                                                        ...
                                                        <asp:PlaceHolder ID="pnlOutStock" runat="server" Visible="false">
                                                        <div class="col-lg-12 mb-2">
                                                            <label class="col-lg-2 col-form-label" style="display: contents;">Time:</label>
                                                            <label class="col-lg-4 col-form-label" style="display: contents;">
                                                                <asp:Label ID="lblCreatedTime" Font-Bold="true" runat="server"></asp:Label></label>
                                                        </div>
                                                        </asp:PlaceHolder>
                                                        <asp:PlaceHolder ID="pnlTotal" runat="server" Visible="false">
                                                        <div class="col-lg-12 mb-2">
