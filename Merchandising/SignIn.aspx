<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignIn.aspx.cs" Inherits="Merchandising.SignIn" %>
<!DOCTYPE html>
	...
	<body data-kt-name="metronic" id="kt_body" class="app-blank app-blank">
		...
		<!--begin::Root-->
			...
			<div class="d-flex flex-column flex-lg-row flex-column-fluid">
							...
							<form class="form w-100" runat="server" >
								...
								<div class="card-body">
									...
									<div class="text-start mb-10">
										...
										<!--end::Title-->
										<!--begin::Text-->
										<div class="text-gray-400 fw-semibold fs-6" data-kt-translate="general-desc">Merchandising</div>
										<!--end::Link-->
									</div>
									...
									<div class="fv-row mb-7">
										<asp:TextBox ID="txtPassword" runat="server" autocomplete="off" placeholder="Password" TextMode="Password" class="form-control form-control-solid" ></asp:TextBox>
				...
				<!--end::Aside-->
				<!--begin::Body-->
				<div class="d-none d-lg-flex flex-lg-row-fluid w-50 bgi-size-cover bgi-position-y-center bgi-position-x-start bgi-no-repeat" style="background-image: url(BO_DIgits/assets/media/bg/Group_1932.png)"></div>
				<!--begin::Body-->
			</div>
