<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="ListCustomerActivity.aspx.cs" Inherits="Merchandising.BO_Digits.en.ListCustomerActivity" %>
...
<%--                                             <telerik:GridButtonColumn CommandName="Edit" Text='<i class="fa fa-edit"></i>' HeaderStyle-Width="50px" EditFormColumnIndex="0" UniqueName="EditColumn">
                                            ...
                                            <telerik:GridBoundColumn DataField="cah_Name" AllowFiltering="true" HeaderStyle-Width="150px"
                                             ...
                                             <telerik:GridBoundColumn DataField="cah_ArabicName" AllowFiltering="true" HeaderStyle-Width="150px"
                                                HeaderStyle-Font-Size="Smaller" HeaderText="Arabic Name" FilterControlWidth="100%"
                                                CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                                HeaderStyle-Font-Bold="true" UniqueName="cah_ArabicName">
                                            </telerik:GridBoundColumn>
                                            ...
                                            <telerik:GridBoundColumn DataField="cah_Description" AllowFiltering="true" HeaderStyle-Width="150px"
                                              ...
                                              <telerik:GridBoundColumn DataField="cah_ArabicDesc" AllowFiltering="true" HeaderStyle-Width="150px"
                                                HeaderStyle-Font-Size="Smaller" HeaderText="Arabic Description" FilterControlWidth="100%"
                                                CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                                HeaderStyle-Font-Bold="true" UniqueName="cah_ArabicDesc">
                                            </telerik:GridBoundColumn>
