    ...
    public partial class AddEditSurveyQuestions : System.Web.UI.Page
    {
        ...
        protected void fillForm()
        {
            ...
            else
            {
                ...
                lstData = Obj.loadList("SelectQuestionsByID", "sp_Survey", ResponseID.ToString());
        ...
        public void LoadData()
        {
            ...
            lstDatas = Obj.loadList("SelectQuestionsDetailsByID", "sp_Survey", ResponseID.ToString());
        ...
        public void Delete(string Mode)
        {
            if (Mode.Equals("1"))
            {
                ...
                DataTable del = Obj.loadList("DeleteQD", "sp_Survey", Ids.ToString());
        ...
        protected void Save()
        {
            ...
            if (ResponseID == 0)
            {
                ...
                DataTable lstClaim = Obj.loadList("AddQuestion", "sp_Survey", Question.ToString(), arr);
            ...
            else
            {
                ...
                string Value = Obj.SaveData("sp_Survey", "updateQuestions", id.ToString(), arr);
        ...
        public void Route()
        {
            DataTable dt = Obj.loadList("selectType", "sp_Survey");
        ...
        {
            DataTable lstType = Obj.loadList("selectTypeByID", "sp_Survey", txtType.SelectedValue.ToString());
