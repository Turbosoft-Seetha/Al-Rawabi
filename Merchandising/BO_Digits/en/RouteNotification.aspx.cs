...
namespace Merchandising.BO_Digits.en
{
    public partial class RouteNotification : System.Web.UI.Page
    {
        ...
        public void Route()
        {
            ddlRoute.DataSource = ObjclsFrms.loadList("SelectFromDropRouteID", "sp_Notifications");
        ...
        public void LoadList()
        {
            ...
            if (!rotID.Equals("0"))
            {
                ...
                lstUser = ObjclsFrms.loadList("ListRouteNotifications", "sp_Notifications", mainCondition.ToString());
