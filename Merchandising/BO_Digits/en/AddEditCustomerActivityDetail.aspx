<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="AddEditCustomerActivityDetail.aspx.cs" Inherits="Merchandising.BO_Digits.en.AddEditCustomerActivityDetail" %>
                        ...
                        <div class="col-lg-12 row">
                          ...
                          <div class="col-lg-4 form-group pb-4">
                               ...
                               <div class="col-lg-4 form-group pb-4">
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadDropDownList ID="ddltype" runat="server" Width="100%" RenderMode="Lightweight" Filter="Contains" >
                                        <Items>
                                           <%-- <telerik:DropDownListItem Text="Active" Value="Y" />--%>
                                            <telerik:DropDownListItem Text="Operational" Value="Operational" Selected="true" />
                                        </Items>
                             ...
                             <div class="col-lg-4 form-group pb-4">
                                ...
                                <div class="col-lg-12">
                                     <telerik:RadDatePicker ID="rdDueDate" DateInput-DateFormat="dd-MMM-yyyy" runat="server" Width="100%" RenderMode="Lightweight"></telerik:RadDatePicker>
                             ...
                             <div class="col-lg-4 form-group pb-4">
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadTextBox ID="txtsortorder" runat="server" CssClass="form-control" Width="100%" RenderMode="Lightweight"></telerik:RadTextBox>
