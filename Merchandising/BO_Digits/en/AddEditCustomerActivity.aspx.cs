...
namespace Merchandising.BO_Digits.en
{
    ...
    public partial class AddEditCustomerActivity : System.Web.UI.Page
    {
        ...
        {
            ddlCustomers.DataSource = ObjclsFrms.loadList("SelCustomer", "sp_Masters", ddlrot.SelectedValue.ToString());
        ...
        public void FillForm()
        {
            ...
            {
                string name,desc,startdate,enddate,cus,rot,arabic,arabicDesc;
                ...
                arabic = lstDatas.Rows[0]["cah_ArabicName"].ToString();
                arabicDesc = lstDatas.Rows[0]["cah_ArabicName"].ToString();
                ...
                txtArabicDesc.Text = arabicDesc.ToString();
            }
        }

        protected void Save()
        {
            string name, desc, startdate, enddate, user,cus,rot,arabic, arabicDesc;
            ...
            arabicDesc = txtArabicDesc.Text.ToString();

            if (ResponseID.Equals("") || ResponseID == 0)
            {
                string[] arr = {  desc, startdate, enddate, user,cus,rot,arabic, arabicDesc };
            ...
            else
            {
                ...
                string[] arr = { name, desc, startdate, enddate, user,cus,rot,arabic, arabicDesc };
