<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="AddEditCustomerActivity.aspx.cs" Inherits="Merchandising.BO_Digits.en.AddEditCustomerActivity" %>
                    ...
                    <div class="card-body row p-8" style="background-color:white;">
                        ...
                        <div class="col-lg-12 row">
                               ...
                               <div class="col-lg-4 form-group pb-4">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadComboBox ID="ddlrot" EmptyMessage="Select Route" runat="server" Width="100%" Filter="Contains"  RenderMode="Lightweight" AutoPostBack="true" CausesValidation="false" OnSelectedIndexChanged="ddlrot_SelectedIndexChanged">
                                        </telerik:RadComboBox>
                             ...
                             <div class="col-lg-4 form-group pb-4">
                                    ...
                                    <div class="col-lg-12">
                                        <telerik:RadComboBox ID="ddlCustomers" EmptyMessage="Select Customer" runat="server" Width="100%" Filter="Contains"  RenderMode="Lightweight">
                                        </telerik:RadComboBox>
                            ...
                            <div class="col-lg-4 form-group pb-4">
                             ...
                             <div class="col-lg-4 form-group pb-4">
                                ...
                                <div class="col-lg-12">
                                 ...
                                 <div class="col-lg-4 form-group pb-4">
                                <label class="control-label col-lg-12">Arabic Description<span class="required"> </span></label>
                                <div class="col-lg-12">
                                    <telerik:RadTextBox ID="txtArabicDesc" runat="server" CssClass="form-control" Width="100%" RenderMode="Lightweight"></telerik:RadTextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server"  ValidationGroup="form" 
                                        ControlToValidate="txtArabicDesc" ErrorMessage="Please Enter Arabic Description" ForeColor="Red" Display="Dynamic"
                                        SetFocusOnError="True"></asp:RequiredFieldValidator><br />
                                </div>
                            </div>
                             ...
                             <div class="col-lg-4 form-group pb-4">
                                ...
                                <div class="col-lg-12">
                                     <telerik:RadDatePicker ID="rdEndDate" DateInput-DateFormat="dd-MMM-yyyy" runat="server" Width="100%" RenderMode="Lightweight"></telerik:RadDatePicker>
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadDropDownList ID="ddlStatus" runat="server" Width="100%" RenderMode="Lightweight">
                                        <Items>
                                            ...
                                            <telerik:DropDownListItem Text="Inactive" Value="N" Selected="true" />
                                        </Items>
