...
namespace Merchandising.BO_Digits.en
{
    public partial class ListCustomerActivity : System.Web.UI.Page
    {
        ...
        public void ListData()
        {
            ...
            if (Mode == 3)
            {
                ...
                if (!rotID.Equals("0"))
                {
                    ...
                    lstUser = ObjclsFrms.loadList("SelectCustomerActivityPerformed", "sp_Dashboard", mainCondition);
            ...
            else if (Mode == 1)
            {
                ...
                if (!rotID.Equals("0"))
                {
                    ...
                    lstUser = ObjclsFrms.loadList("SelectCustomerActivityopen", "sp_Dashboard", mainCondition);
                    grvRpt.DataSource = lstUser;
                }
            }
            else if (Mode == 2)
            {
                ...
                if (!rotID.Equals("0"))
                {
                    ...
                    lstUser = ObjclsFrms.loadList("SelectCustomerActivitycompleted", "sp_Dashboard", mainCondition);
                    grvRpt.DataSource = lstUser;
                }
            }
            else
        ...
        {
            Response.Redirect("AddEditCustomerActivity.aspx?Id=0");
        }
