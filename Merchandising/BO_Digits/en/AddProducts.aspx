<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="AddProducts.aspx.cs" Inherits="Merchandising.BO_Digits.en.AddProducts" %>
...
<AjaxSettings>
                                ...
                                <div class="kt-portlet__body">
                                    ...
                                    <div class="col-lg-12 row">
                                        ...
                                        <div class="col-lg-4 form-group">
                                            ...
                                            <div class="col-lg-12">
                                                <telerik:RadNumericTextBox ID="txtupc" runat="server" CssClass="form-control" RenderMode="Lightweight" Width="100%" NumberFormat-AllowRounding="false" DecimalDigits="0"></telerik:RadNumericTextBox>
    ...
    <!--end::SuccessModal-->
     <!--begin::FailedModal-->
    <div class="modal fade" id="Failmsg" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Oops..!</h5>
