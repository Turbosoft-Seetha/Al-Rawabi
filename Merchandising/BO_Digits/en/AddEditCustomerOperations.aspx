<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="AddEditCustomerOperations.aspx.cs" Inherits="Merchandising.BO_Digits.en.AddEditCustomerOperations" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Actions" runat="server">
      <telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                                <asp:LinkButton ID="btnCancel" Width="100px" runat="server"
                                    ...
                                    CausesValidation="False"  OnClick="lnkSave_Click" />
