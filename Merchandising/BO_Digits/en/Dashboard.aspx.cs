...
namespace Merchandising.BO_Digits.en
{
    public partial class Dashboard : System.Web.UI.Page
    {
        ...
        //public void Route()
        //{
        //    ddlRoute.DataSource = ObjclsFrms.loadList("SelectRoute", "sp_Route");
        ...
        public void OutOfStock(string route)
        {
            ...
            string toDate = DateTime.Parse(rdendDate.SelectedDate.ToString()).ToString("yyyyMMdd");
            string[] arr = { fromDate, toDate };
            DataTable lstOutOfStockItem = ObjclsFrms.loadList("OOSItemCount", "sp_Dashboard", route, arr);
            DataTable lstOutOfStockCustomer = ObjclsFrms.loadList("OOSCustomerCount", "sp_Dashboard", route, arr);
            DataTable lstOutOfStockPerformed = ObjclsFrms.loadList("OOSPerformed", "sp_Dashboard", route, arr);
        ...
        public void ItemAvailability(string route)
        {
            ...
            string toDate = DateTime.Parse(rdendDate.SelectedDate.ToString()).ToString("yyyyMMdd");
            string[] arr = { fromDate, toDate };
            DataTable lstNotAvailableItem = ObjclsFrms.loadList("ItemAvailabilityCount", "sp_Dashboard", route, arr);
            DataTable lstNotAvailableCustomer = ObjclsFrms.loadList("CustomerAvailabilityCount", "sp_Dashboard", route, arr);
            DataTable lstNotAvailablePerformed = ObjclsFrms.loadList("ItemAvailbilityPerformed", "sp_Dashboard", route, arr);
        ...
        public void Survey(string route)
        {
            ...
            string toDate = DateTime.Parse(rdendDate.SelectedDate.ToString()).ToString("yyyyMMdd");
            string[] arr = { fromDate, toDate };
            DataTable lstAssignedSurvey = ObjclsFrms.loadList("AssignedSurveysCount", "sp_Dashboard", route, arr);
            DataTable lstCompletedSurvey = ObjclsFrms.loadList("CompletedSurveysCount", "sp_Dashboard", route, arr);
            DataTable lstSurveyPerformed = ObjclsFrms.loadList("SurveyPerformed", "sp_Dashboard", route, arr);
        ...
        public void AssetTracking(string route)
        {
            ...
            string toDate = DateTime.Parse(rdendDate.SelectedDate.ToString()).ToString("yyyyMMdd");
            string[] arr = { fromDate, toDate };
            DataTable lstAssignedAsset = ObjclsFrms.loadList("AssignedAssetTrackingCount", "sp_Dashboard", route, arr);
            DataTable lstTrackedAsset = ObjclsFrms.loadList("TrackedAssetTrackingCount", "sp_Dashboard", route, arr);
            DataTable lstAssetTrackingPerformed = ObjclsFrms.loadList("AssetTrackingPerformed", "sp_Dashboard", route, arr);
        ...
        public void DispAgreements(string route)
        {
            ...
            string toDate = DateTime.Parse(rdendDate.SelectedDate.ToString()).ToString("yyyyMMdd");
            string[] arr = { fromDate, toDate };
            DataTable lstNewAgreements = ObjclsFrms.loadList("NewDisplayAgreementsCount", "sp_Dashboard", route, arr);
            DataTable lstActiveAgreements = ObjclsFrms.loadList("ActiveDisplayAgreementsCount", "sp_Dashboard", route, arr);
            DataTable lstAgreementsPerformed = ObjclsFrms.loadList("DisplayAgreementsPerformed", "sp_Dashboard", route, arr);
        ...
        public void Task(string route)
        {
            ...
            string toDate = DateTime.Parse(rdendDate.SelectedDate.ToString()).ToString("yyyyMMdd");
            string[] arr = { fromDate, toDate };
            DataTable lstAssignedTask = ObjclsFrms.loadList("AssignedTaskCount", "sp_Dashboard", route, arr);
            DataTable lstCompletedTask = ObjclsFrms.loadList("CompletedTaskCount", "sp_Dashboard", route, arr);
            DataTable lstTaskPerformed = ObjclsFrms.loadList("CustomerTaskPerformed", "sp_Dashboard", route, arr);
        ...
        public void CustomerActivities(string route)
        {
            ...
            string toDate = DateTime.Parse(rdendDate.SelectedDate.ToString()).ToString("yyyyMMdd");
            string[] arr = { fromDate, toDate };
            DataTable lstOpenCusAct = ObjclsFrms.loadList("OpenCustomerActivityCount", "sp_Dashboard", route, arr);
            DataTable lstCompletedCusAct = ObjclsFrms.loadList("CompletedCustomerActivityCount", "sp_Dashboard", route, arr);
            DataTable lstCusActPerformed = ObjclsFrms.loadList("CustomerActivityPerformed", "sp_Dashboard", route, arr);
        ...
        public void Requests(string route)
        {
            ...
            string toDate = DateTime.Parse(rdendDate.SelectedDate.ToString()).ToString("yyyyMMdd");
            string[] arr = { fromDate, toDate };
            DataTable lstNewRequest = ObjclsFrms.loadList("NewRequestCount", "sp_Dashboard", route, arr);
            DataTable lstRepondedRequest = ObjclsFrms.loadList("RepondedRequestCount", "sp_Dashboard", route, arr);
            DataTable lstReqPerformed = ObjclsFrms.loadList("ReqPerformed", "sp_Dashboard", route, arr);
        ...
        public void General(string route)
        {
            ...
            string toDate = DateTime.Parse(rdendDate.SelectedDate.ToString()).ToString("yyyyMMdd");
            string[] arr = { fromDate, toDate };
            DataTable lstDeliveryCheck = ObjclsFrms.loadList("DeliveryCheckCount", "sp_Dashboard", route, arr);
            DataTable lstItemPricing = ObjclsFrms.loadList("ItemPricingCount", "sp_Dashboard", route, arr);
            DataTable lstCompetitorActivities = ObjclsFrms.loadList("CompetitorActivitiesCount", "sp_Dashboard", route, arr);
            DataTable lstCustomerInventory = ObjclsFrms.loadList("InventoryCount", "sp_Dashboard", route, arr);
            DataTable lstComplaints = ObjclsFrms.loadList("ComplaintsCount", "sp_Dashboard", route, arr);
            DataTable lstGComplaints = ObjclsFrms.loadList("GComplaintsCount", "sp_Dashboard", route, arr);
            DataTable lstImageCapture = ObjclsFrms.loadList("ImageCaptureCount", "sp_Dashboard", route, arr);
        ...
        public void TotalCustomerVisit(string route)
        {
            ...
            string toDate = DateTime.Parse(rdendDate.SelectedDate.ToString()).ToString("yyyyMMdd");
            string[] arr = { fromDate, toDate };
            DataTable lstCustomerVisit = ObjclsFrms.loadList("SelectTotalCustomerVisited", "sp_Dashboard", route, arr);
        ...
        protected void ButtonCusAct_Click(object sender, EventArgs e)
        {
            ...
            string rot = Rotids();
            Session["Route"] = rot;
            Response.Redirect("ListCustomerActivity.aspx?Mode=3");
        }
        ...
        protected void lnkOpenCusAct_Click(object sender, EventArgs e)
        {
            ...
            string rot = Rotids();
            Session["Route"] = rot;
            Response.Redirect("ListCustomerActivity.aspx?Mode=1");
        }
        ...
        protected void lnkCompletedCusAct_Click(object sender, EventArgs e)
        {
            ...
            string rot = Rotids();
            Session["Route"] = rot;
            Response.Redirect("ListCustomerActivity.aspx?Mode=2");
        }
        ...
        protected void ButtonRequest_Click(object sender, EventArgs e)
        {
            ...
            string rot = Rotids();
            Session["Route"] = rot;
            Response.Redirect("ListNewRequest.aspx?Mode=3");
        }
        ...
        protected void lnkNewRequest_Click(object sender, EventArgs e)
        {
            ...
            string rot = Rotids();
            Session["Route"] = rot;
            Response.Redirect("ListNewRequest.aspx?Mode=1");
        }
        ...
        protected void lnkRepondedRequest_Click(object sender, EventArgs e)
        {
            ...
            string rot = Rotids();
            Session["Route"] = rot;
            Response.Redirect("ListNewRequest.aspx?Mode=2");
        }
