...
namespace Merchandising.BO_Digits.en
{
    public partial class AddEditCustomerCategory : System.Web.UI.Page
    {
        ...
        public void FillForm()
        {
            ...
            {
                string name, ArabName, status, code, Cus;
                name = lstDatas.Rows[0]["cuc_Name"].ToString();
                ArabName = lstDatas.Rows[0]["cuc_NameArabic"].ToString();
                code = lstDatas.Rows[0]["cuc_Code"].ToString();
                Cus = lstDatas.Rows[0]["cuc_cum_ID"].ToString();
        ...
        protected void Save()
        {
            string name, code, Cus, user, status, ArabName;
            ...
            if (ResponseID.Equals("") || ResponseID == 0)
            {
                ...
                string[] arr = { ArabName.ToString(), code.ToString(), Cus.ToString(), user.ToString(), status.ToString() };
            ...
            else
            {
                ...
                string[] arr = { ArabName.ToString(), code.ToString(), Cus.ToString(), user.ToString(), status.ToString(), id.ToString() };
