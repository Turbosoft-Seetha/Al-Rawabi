...
namespace Merchandising.BO_Digits.en
{
    public partial class AddEditCustomerActivityDetail : System.Web.UI.Page
    {
        ...
        public void FillForm()
        {
            ...
            {
                string name, desc, duedate, SortOrder,type,img,arabic, arabicDesc;
                ...
                arabic = lstDatas.Rows[0]["cad_Code"].ToString();
        ...
        protected void Save()
        {
            string name, desc, duedate, user, SortOrder,type,img,arabic, arabicDesc;
            ...
            if (img != null)
            {
                if (ResponseID.Equals("") || ResponseID == 0)
                {
                    ...
                    string[] arr = { desc, duedate, SortOrder, user,  HID.ToString(), type, img ,arabic, arabicDesc };
                ...
                else
                {
                    ...
                    string[] arr = { name, desc, duedate, SortOrder, user,  type ,img,arabic, arabicDesc };
