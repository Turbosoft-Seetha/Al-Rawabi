<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="Inventory.aspx.cs" Inherits="Merchandising.BO_Digits.en.Inventory" %>
                    ...
                    <div class="kt-portlet__head" style="padding-bottom: 10px">
                        <div class="col-lg-12 row">
                         ...
                         <div class="col-lg-3" >
                                    ...
                                    <div class="col-lg-2" style="text-align: center; top: 19px;padding-top:10px;">
                                    ...
                                    <MasterTableView AutoGenerateColumns="False" FilterItemStyle-Font-Size="XX-Small" CanRetrieveAllData="false"
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridTemplateColumn HeaderStyle-Width="60px" AllowFiltering="false" HeaderText="" HeaderStyle-Font-Size="Smaller" HeaderStyle-Font-Bold="true">
                                                <ItemTemplate>
                                                    <asp:ImageButton CommandName="Item" ID="RadImageButton2" Visible="true" AlternateText="Detail" runat="server"
                                            ...
                                            <telerik:GridBoundColumn DataField="TransTime" AllowFiltering="true" HeaderStyle-Width="100px"
                                             ...
                                             <telerik:GridBoundColumn DataField="inh_Number" AllowFiltering="true" HeaderStyle-Width="140px"
                                            ...
                                            <telerik:GridBoundColumn DataField="inh_Remarks" AllowFiltering="true" HeaderStyle-Width="120px"
                                                HeaderStyle-Font-Size="Smaller" HeaderText="Remarks" FilterControlWidth="100%"
                                                CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                                HeaderStyle-Font-Bold="true" UniqueName="inh_Remarks">
                                            </telerik:GridBoundColumn>
