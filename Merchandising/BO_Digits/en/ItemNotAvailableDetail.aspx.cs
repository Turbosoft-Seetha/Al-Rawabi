...
namespace Merchandising.BO_Digits.en
{
    public partial class ItemNotAvailableDetail : System.Web.UI.Page
    {
        ...
        public void HeaderData()
        {
            ...
            lstDatas = ObjclsFrms.loadList("SelectItemNotAvailableHeader", "sp_Report", ResponseID.ToString());
        ...
        public void ListData()
        {
            ...
            lstUser = ObjclsFrms.loadList("SelectItemNotAvailableDetail", "sp_Report", ResponseID.ToString(), arr);
        ...
        private void SpreadStreamProcessingForXLSXAndCSV(DataTable dt, SpreadDocumentFormat docFormat = SpreadDocumentFormat.Xlsx, string sheetName = "Sheet1")
        {
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                Response.AppendHeader("Content-Disposition", string.Format("attachment; filename={0}.{1}", "Item Not Available Detail", "Xlsx"));
