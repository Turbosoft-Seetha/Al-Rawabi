<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="OutOfStock.aspx.cs" Inherits="Merchandising.BO_Digits.en.OutOfStock" %>
   ...
   <div class="card-body p-8" style="background-color:white;">
     ...
     <telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel2">
                         ...
                         <div class="col-lg-3" >
                                    ...
                                    <div class="col-lg-2" style="text-align: center; top: 29px;padding-top:15px;">
                                ...
                                <telerik:RadGrid RenderMode="Lightweight" runat="server" EnableLinqExpressions="false" AllowMultiRowSelection="false"
                                    ...
                                    <MasterTableView AutoGenerateColumns="False" FilterItemStyle-Font-Size="XX-Small" CanRetrieveAllData="false"
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridTemplateColumn HeaderStyle-Width="50px" HeaderText="Detail" AllowFiltering="false" HeaderStyle-Font-Size="Smaller" HeaderStyle-Font-Bold="true">
                                                <ItemTemplate>
                                           ...
                                           <%-- <telerik:GridBoundColumn DataField="VisitStart" AllowFiltering="true" HeaderStyle-Width="120px"
                                            ...
                                            <telerik:GridBoundColumn DataField="CompletedDate" AllowFiltering="true" HeaderStyle-Width="100px"
                                                HeaderStyle-Font-Size="Smaller" HeaderText="Completed Time" FilterControlWidth="100%"
                                                CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
