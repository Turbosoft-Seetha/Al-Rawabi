...
namespace Merchandising.BO_Digits.en
{
    public partial class AddSurveyCustomerRoute : System.Web.UI.Page
    {
        ...
        public void LoadData()
        {
            ...
            string[] ar = { ddlRoute.SelectedValue.ToString() };
            lstUser = ObjclsFrms.loadList("SelectCusRotSeqForSurvey", "sp_Survey", ResponseID.ToString(),ar);
        ...
        public void ListData()
        {
            ...
            lstUser = ObjclsFrms.loadList("SelectCustomerRouteSurvey", "sp_Survey", ResponseID.ToString(),ar);
            if (lstUser.Rows.Count >= 0)
            {
