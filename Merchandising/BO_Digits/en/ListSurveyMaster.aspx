<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="ListSurveyMaster.aspx.cs" Inherits="Merchandising.BO_Digits.en.ListSurveyMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Actions" runat="server">
 ...
 <asp:LinkButton ID="lnkAddQuestion" runat="server" CssClass="btn btn-sm fw-bold btn-primary" Text="Add" OnClick="lnkAddQuestion_Click" ></asp:LinkButton>
