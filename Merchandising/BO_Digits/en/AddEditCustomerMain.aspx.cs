...
namespace Merchandising.BO_Digits.en
{
    public partial class AddEditCustomerMain : System.Web.UI.Page
    {
        ...
        public void FillForm()
        {
            ...
            {
                string Name, ArabicName, Status, Code;
        ...
        protected void Save()
        {
            string Name, ArabicName, Status, user, Code;
            ...
            {
                string[] arr = { ArabicName, user, Status, Code };
            ...
            else
            {
                ...
                string[] arr = { ArabicName, user, Status, Code, id };
