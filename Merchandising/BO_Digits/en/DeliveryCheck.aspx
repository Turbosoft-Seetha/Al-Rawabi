<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="DeliveryCheck.aspx.cs" Inherits="Merchandising.BO_Digits.en.DeliveryCheck" %>
                    ...
                    <div class="kt-portlet__head" style=" padding-bottom: 10px">
                        <div class="col-lg-12 row">
                         ...
                         <div class="col-lg-3" >
                                    ...
                                    <div class="col-lg-2" style="text-align: center; top: 19px;padding-top:25px;justify-content:end;" >
