<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="AddEditRegion.aspx.cs" Inherits="Merchandising.BO_Digits.en.AddEditRegion" %>
                        ...
                        <div class="col-lg-12 row">
                            ...
                            <div class="col-lg-4 form-group">
                             ...
                             <div class="col-lg-4 form-group">
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadTextBox ID="txtARname" runat="server" CssClass="form-control" Width="100%"></telerik:RadTextBox>
