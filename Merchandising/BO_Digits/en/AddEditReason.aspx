<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="AddEditReason.aspx.cs" Inherits="Merchandising.BO_Digits.en.AddEditReason" %>
    ...
    <div class="card-body p-8" style="background-color:white;"> 
      <div class="col-lg-12 row">
                            ...
                            <div class="col-lg-4 form-group" style="padding-bottom: 15px;">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server"   ValidationGroup="form"
                                        ControlToValidate="txtname" ErrorMessage="Please Enter Reason Name" ForeColor="Red" Display="Dynamic"
                            ...
                            <div class="col-lg-4 form-group" style="padding-bottom: 15px;">
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadTextBox ID="txtarabic" runat="server" CssClass="form-control" Width="100%" RenderMode="Lightweight"></telerik:RadTextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"   ValidationGroup="form"
                                        ControlToValidate="txtarabic" ErrorMessage="Please Enter Arabic Reason Name" ForeColor="Red" Display="Dynamic"
                                        SetFocusOnError="True"></asp:RequiredFieldValidator><br />
                                </div>
                            </div>
                            <div class="col-lg-4 form-group" style="padding-bottom: 15px;">
