<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="RouteCustomerSettings.aspx.cs" Inherits="Merchandising.BO_Digits.en.RouteCustomerSettings" %>
            ...
            <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel2">
                ...
                <div class="col-lg-12 row">
                                ...
                                <div class="col-lg-4 form-group mb-4">
                                    ...
                                    <div class="col-lg-12">
                                         <telerik:RadComboBox ID="ddlCustomer" runat="server" EmptyMessage="Select Customer" CausesValidation="false" Width="100%" Filter="Contains" CheckBoxes="true" EnableCheckAllItemsCheckBox="true" ></telerik:RadComboBox>
                 ...
                 <asp:PlaceHolder runat="server" ID="SingleValued" Visible="false">
                                <div class="col-lg-4 form-group  mb-4">
                                <label class="control-label col-lg-12">Settings Text <span class="required"></span></label>
                                <div class="col-lg-12">
                                   <telerik:RadComboBox ID="ddlSettingsText" runat="server" EmptyMessage="Select settings value" CausesValidation="false" Width="100%" Filter="Contains"></telerik:RadComboBox>
                               <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ValidationGroup="form"
                                ControlToValidate="ddlSettingsText" ErrorMessage="Please Select Settings Value" ForeColor="Red" Display="Dynamic"
                                SetFocusOnError="True"></asp:RequiredFieldValidator><br />
                                </div>
                            </div>
                  ...
                  <asp:PlaceHolder runat="server" ID="MultipleValued" Visible="false">
                                <div class="col-lg-4 form-group  mb-4">
                                <label class="control-label col-lg-12">Settings Text <span class="required"></span></label>
                                <div class="col-lg-12">
