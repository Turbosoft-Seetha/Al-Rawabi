<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="AddEditCompetitorActivityType.aspx.cs" Inherits="Merchandising.BO_Digits.en.AddEditCompetitorActivityType" %>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <span>Competitor activity type has been updated successfully.</span>
                </div>
                <div class="modal-footer">
