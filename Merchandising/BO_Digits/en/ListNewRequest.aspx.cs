...
namespace Merchandising.BO_Digits.en
{
    public partial class ListNewRequest : System.Web.UI.Page
    {
        ...
        public void ListData()
        {
            ...
            if(Mode == 3)
            {
                ...
                if (!rotID.Equals("0"))
                {
                    ...
                    lstUser = ObjclsFrms.loadList("SelectNewRequestPerformed", "sp_Dashboard", mainCondition);
            ...
            else if(Mode == 1)
            {
                ...
                if (!rotID.Equals("0"))
                {
                    ...
                    lstUser = ObjclsFrms.loadList("SelectNewRequestopen", "sp_Dashboard", mainCondition);
                    grvRpt.DataSource = lstUser;
                }
            }
            else if(Mode == 2)
            {
                ...
                if (!rotID.Equals("0"))
                {
                    ...
                    lstUser = ObjclsFrms.loadList("SelectNewRequestResponded", "sp_Dashboard", mainCondition);
                    grvRpt.DataSource = lstUser;
                }
            }
            else 
        ...
        {
            string rotID = Rot();
            string routeCondition = " dph_rot_ID in (" + rotID + ")";
            Customers(routeCondition);
        }
