...
namespace Merchandising.BO_Digits.en
{
    public partial class AddEditAgreementType : System.Web.UI.Page
    {
        ...
        {
            DataTable lstDatas = ObjclsFrms.loadList("SelectAgrTypeByID", "sp_Masters", ResponseID.ToString());
        ...
        protected void Save()
        {
            ...
            if (ResponseID.Equals("") || ResponseID == 0)
            {
                ...
                string Value = ObjclsFrms.SaveData("sp_Masters", "InsertAgrType", name.ToString(), arr);
            ...
            else
            {
                ...
                string Value = ObjclsFrms.SaveData("sp_Masters", "UpdateAgrType", name.ToString(), arr);
                int res = Int32.Parse(Value.ToString());
                if (res > 0)
        ...
        {
            Response.Redirect("/BO_Digits/en/ListAgrementType.aspx");
