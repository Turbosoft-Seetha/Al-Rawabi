<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="RouteSettingsMaster.aspx.cs" Inherits="Merchandising.BO_Digits.en.RouteSettingsMaster" %>
            ...
            <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel2">
                ...
                <div class="col-lg-12 row">
                                ...
                                <div class="col-lg-4 form-group mb-4">
                                    ...
                                    <div class="col-lg-12">
                                         <telerik:RadComboBox ID="ddlRoute" runat="server" EmptyMessage="Select Route" CausesValidation="false" Width="100%" Filter="Contains" CheckBoxes="true" EnableCheckAllItemsCheckBox="true" ></telerik:RadComboBox>
