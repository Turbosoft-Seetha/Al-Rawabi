<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="AddEditDepotSubArea.aspx.cs" Inherits="Merchandising.BO_Digits.en.AddEditDepotSubArea" %>
                   ...
                   <telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                    ...
                    <div class="kt-portlet__body">
                        <div class="col-lg-12 row">
                           ...
                           <div class="col-lg-4 form-group" >
                                <label class="control-label col-lg-12">Depot Subarea</label>
                                <div class="col-lg-12">
                             ...
                             <div class="col-lg-4 form-group" >
                                <label class="control-label col-lg-12">Depot Area</label>
                                <div class="col-lg-12">
