<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="AddEditComplaintsNature.aspx.cs" Inherits="Merchandising.BO_Digits.en.AddEditComplaintsNature" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
     ...
     <div class="col-lg-12 row">
                            ...
                            <div class="col-lg-4 form-group" style="padding-bottom: 15px;">
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadComboBox ID="ddlTypes" runat="server" Width="100%" Filter="Contains" EmptyMessage="Select Type" RenderMode="Lightweight"></telerik:RadComboBox>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <span>Complaints nature has been updated successfully.</span>
                </div>
                <div class="modal-footer">
