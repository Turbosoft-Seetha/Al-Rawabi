...
namespace Merchandising.BO_Digits.en
{
    public partial class AddEditAgreementCat : System.Web.UI.Page
    {
        ...
        {
            DataTable lstDatas = ObjclsFrms.loadList("selAgreementCatById", "sp_Masters", ResponseID.ToString());
        ...
        protected void Save()
        {
            ...
            if (ResponseID.Equals("") || ResponseID == 0)
            {
                ...
                string Value = ObjclsFrms.SaveData("sp_Masters", "insAgreementCat", Code, arr);
            ...
            else
            {
                ...
                string Value = ObjclsFrms.SaveData("sp_Masters", "updateAgreementCat", Code, arr);
                int res = Int32.Parse(Value.ToString());
                if (res > 0)
