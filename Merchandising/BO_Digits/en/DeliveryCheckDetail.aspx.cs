    ...
    public partial class DeliveryCheckDetail : System.Web.UI.Page
    {
        ...
        public void HeaderData()
        {
            ...
            if (lstDatas.Rows.Count > 0)
            {
                ...
                Label lblTransDate = (Label)rp.FindControl("lblTransDate");
                Label lblStatus = (Label)rp.FindControl("lblStatus");

                rp.Text = "Transaction Number: " + lstDatas.Rows[0]["dch_TransNumber"].ToString();
               ...
               // lblTransaction.Text = lstDatas.Rows[0]["dch_TransNumber"].ToString();
                ...
                lblTransDate.Text = lstDatas.Rows[0]["CreatedDate"].ToString();
            }
        }
        ...
        private void SpreadStreamProcessingForXLSXAndCSV(DataTable dt, SpreadDocumentFormat docFormat = SpreadDocumentFormat.Xlsx, string sheetName = "Sheet1")
        {
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                Response.AppendHeader("Content-Disposition", string.Format("attachment; filename={0}.{1}", "Delivery Check Detail", "Xlsx"));
