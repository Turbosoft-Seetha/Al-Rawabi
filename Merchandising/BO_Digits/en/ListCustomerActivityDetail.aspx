<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="ListCustomerActivityDetail.aspx.cs" Inherits="Merchandising.BO_Digits.en.ListCustomerActivityDetail" %>
                                        ...
                                        <Columns>
                                           ...
                                           <%--  <telerik:GridButtonColumn CommandName="Edit" Text='<i class="fa fa-edit"></i>' HeaderStyle-Width="60px" EditFormColumnIndex="0" UniqueName="EditColumn">
                                            ...
                                            <telerik:GridBoundColumn DataField="cad_Name" AllowFiltering="true" HeaderStyle-Width="150px"
                                             ...
                                             <telerik:GridBoundColumn DataField="cad_ArabicName" AllowFiltering="true" HeaderStyle-Width="150px"
                                                HeaderStyle-Font-Size="Smaller" HeaderText="Arabic Name" FilterControlWidth="100%"
                                                CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                                HeaderStyle-Font-Bold="true" UniqueName="cad_ArabicName">
                                            </telerik:GridBoundColumn>
                                            ...
                                            <telerik:GridBoundColumn DataField="cad_Description" AllowFiltering="true" HeaderStyle-Width="100px"
                                              ...
                                              <telerik:GridBoundColumn DataField="cad_ArabicDesc" AllowFiltering="true" HeaderStyle-Width="150px"
                                                HeaderStyle-Font-Size="Smaller" HeaderText="Arabic Description" FilterControlWidth="100%"
                                                CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                                HeaderStyle-Font-Bold="true" UniqueName="cad_ArabicDesc">
                                            </telerik:GridBoundColumn>
