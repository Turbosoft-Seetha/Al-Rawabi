<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="AddEditCustomerBrochure.aspx.cs" Inherits="Merchandising.BO_Digits.en.AddEditCustomerBrochure" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Actions" runat="server">
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel2">
        ...
        &nbsp;
                                   <asp:LinkButton ID="lnkSaves" runat="server" CssClass="btn btn-sm fw-bold btn-primary" Text="Proceed"
                                       OnClick="lnkSaves_Click" CausesValidation="true" ValidationGroup="form"></asp:LinkButton>
        ...
        <telerik:RadAjaxPanel ID="rdd" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
            <div class="col-lg-12 row">
                <div class="col-lg-4 form-group" style="padding-bottom: 15px;">
                    ...
                    <div class="col-lg-12">
                        <telerik:RadComboBox ID="ddlRoute" runat="server" Width="100%" Filter="Contains" EmptyMessage="Select Route" AutoPostBack="true" OnSelectedIndexChanged="ddlRoute_SelectedIndexChanged" RenderMode="Lightweight"></telerik:RadComboBox>
                ...
                <div class="col-lg-4 form-group" style="padding-bottom: 15px;">
                    ...
                    <div class="col-lg-12">
                        <telerik:RadComboBox ID="ddlCustomers" EmptyMessage="Select Customers" runat="server" ValidationGroup="form"
                            Width="100%" Filter="Contains" CheckBoxes="true" EnableCheckAllItemsCheckBox="true" AutoPostBack="true" RenderMode="Lightweight">
                        </telerik:RadComboBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ValidationGroup="form"
                            ControlToValidate="ddlCustomers" ErrorMessage="Please Select Cusomers" Display="Dynamic" ForeColor="Red"
                            SetFocusOnError="True"></asp:RequiredFieldValidator>
                    </div>
                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <span>Customer brochure has been updated successfully.</span>
                </div>
                <div class="modal-footer">
