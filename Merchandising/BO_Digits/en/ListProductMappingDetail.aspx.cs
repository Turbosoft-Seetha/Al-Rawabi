...
namespace Merchandising.BO_Digits.en
{
    public partial class ListProductMappingDetail : System.Web.UI.Page
    {
        ...
        {
            DataTable dt = ObjclsFrms.loadList("SelProductforMappingDetail", "sp_Masters", ResponseID.ToString());
            if (dt.Rows.Count > 0)
            {
        ...
        public void ListData()
        {
            ...
            lstUser = ObjclsFrms.loadList("SelProductMappingDetail", "sp_Masters", ResponseID.ToString());
        ...
        public void HeaderData()
        {
            ...
            lstDatas = ObjclsFrms.loadList("SelProductMappingGroupByID", "sp_Masters", ResponseID.ToString());
        ...
        protected void Save()
        {
            ...
            string Value = ObjclsFrms.SaveData("sp_Masters", "InsertProductMappingDetail", ResponseID.ToString(), arr);
        ...
        public void Delete()
        {
            try
            {
                ...
                string[] arr = { };
                string resp = ObjclsFrms.SaveData("sp_Masters", "Deletepmd", proid.ToString(), arr);
