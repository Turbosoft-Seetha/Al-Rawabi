...
namespace Merchandising.BO_Digits.en
{
    public partial class AddEditAgreementOffer : System.Web.UI.Page
    {
        ...
        {
            DataTable lstDatas = ObjclsFrms.loadList("selAgreementOfferById", "sp_Masters", ResponseID.ToString());
        ...
        protected void Save()
        {
            ...
            if (ResponseID.Equals("") || ResponseID == 0)
            {
                ...
                string Value = ObjclsFrms.SaveData("sp_Masters", "insAgreementOffer", Name, arr);
            ...
            else
            {
                ...
                string Value = ObjclsFrms.SaveData("sp_Masters", "updateAgreementOffer", Name, arr);
                int res = Int32.Parse(Value.ToString());
                if (res > 0)
