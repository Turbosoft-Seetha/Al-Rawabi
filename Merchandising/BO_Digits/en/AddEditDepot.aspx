<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="AddEditDepot.aspx.cs" Inherits="Merchandising.BO_Digits.en.AddEditDepot" %>
                        ...
                        <div class="col-lg-12 row">
                           ...
                           <div class="col-lg-4 form-group" >
                             ...
                             <div class="col-lg-4 form-group" >
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadComboBox ID="ddlRegion" runat="server" EmptyMessage="Select Region" Width="100%" ></telerik:RadComboBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ValidationGroup="form"
                                        ControlToValidate="ddlRegion" ErrorMessage="Please select Region" ForeColor="Red" Display="Dynamic"
                                        SetFocusOnError="True"></asp:RequiredFieldValidator><br />
                                </div>
                            </div>
