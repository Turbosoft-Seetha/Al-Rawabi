<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="AddEditSurveyQuestions.aspx.cs" Inherits="Merchandising.BO_Digits.en.AddEditSurveyQuestions" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <div class="card-body p-8" style="background-color:white;"> 
      <asp:PlaceHolder runat="server" ID="sq" Visible="false">
     <h4>Survey Question  <telerik:RadLabel runat="server" ID="labelqno" Text=""></telerik:RadLabel> </h4>
          </asp:PlaceHolder>
      ...
      <asp:PlaceHolder ID="pnls" runat="server" Visible="false">
                        ...
                        <div class="kt-portlet__body">
                                ...
                                <div class="col-lg-12 row">
                                    ...
                                    <div class="col-lg-2 form-group" style="padding-bottom: 15px;" hidden="hidden">
                                    ...
                                    <div class="col-lg-2 form-group" style="padding-bottom: 15px; padding-top: 10px;">
