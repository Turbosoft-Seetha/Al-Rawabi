<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="ListCustomerClass.aspx.cs" Inherits="Merchandising.BO_Digits.en.ListCustomerClass" %>
                        ...
                        <div class="kt-portlet__body">
                            ...
                            <telerik:RadGrid RenderMode="Lightweight" runat="server" EnableLinqExpressions="false" AllowMultiRowSelection="true"
                                ...
                                <Columns>
                                   ...
                                   <telerik:GridBoundColumn DataField="cls_Code" AllowFiltering="true" HeaderStyle-Width="100px"
                                            HeaderStyle-Font-Size="Smaller" HeaderText="Code" FilterControlWidth="100%"
                                            CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                            HeaderStyle-Font-Bold="true" UniqueName="cls_Code">
                                     ...
                                     <telerik:GridBoundColumn DataField="cuc_Name" AllowFiltering="true" HeaderStyle-Width="100px"
