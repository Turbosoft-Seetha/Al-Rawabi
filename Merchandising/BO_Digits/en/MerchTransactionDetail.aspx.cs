...
{
    public partial class MerchTransactionDetail : System.Web.UI.Page
    {
        ...
        public void GetData()
        {
            ...
            string[] arr = { };
            lstDatas = ObjclsFrms.loadList(proc, "sp_UserDailyProcessDetail", HID.ToString(), arr, true);
        ...
        protected void grvRpt_ItemCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
        {
            if (e.CommandName.Equals("Detail"))
            {
                ...
                Response.Redirect("MerchOthersDetail.aspx?id=" + ResponseID.ToString() + "&&Mode=" + Request.Params["Mode"].ToString() + "&&DID=" + id + "&&HID=" + HID + "&&cusID=" + cusID.ToString());
            }
        }
        ...
        protected void grvRpt_ItemDataBound(object sender, Telerik.Web.UI.GridItemEventArgs e)
        {
            ...
            else if ((Request.Params["Mode"].ToString().Equals("OS")) || (Request.Params["Mode"].ToString().Equals("CAT")))
            {
                if (e.Item is GridDataItem)
                {
                   ...
                   if( imah2 == "")
                    {
                        ...
                        hl.NavigateUrl = "";
                        hl.Controls.Add(img);
                        dataItem["Images2"].Controls.Add(hl);
                    }
                }
