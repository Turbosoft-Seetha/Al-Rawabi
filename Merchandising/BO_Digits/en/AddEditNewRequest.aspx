<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="AddEditNewRequest.aspx.cs" Inherits="Merchandising.BO_Digits.en.AddEditNewRequest" %>
      ...
      <div class="card-body row p-8" style="background-color:white;">
                        <div class="col-lg-12 row">
                            ...
                            <div class="col-lg-4 form-group pb-4">
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadTextBox ID="txtcode" runat="server" CssClass="form-control" Width="100%" Enabled="false" RenderMode="Lightweight"></telerik:RadTextBox>
                            ...
                            <div class="col-lg-4 form-group pb-4">
                                ...
                                <div class="col-lg-12">
                                    <telerik:RadDropDownList ID="ddlResponse" runat="server" Width="100%" RenderMode="Lightweight">
                                        <Items>
                                ...
                                <div class="col-lg-12">
                                  ...
                                  <div class="col-lg-4">
                                    ...
                                    <div class="col-lg-12 row" style="margin-left:5px;">
                                        <telerik:RadAsyncUpload RenderMode="Lightweight" runat="server" MaxFileInputsCount="5"
                                       ...
                                       <%-- <div class="col-lg-12 mt-2">
                                        ...
                                        <%--</asp:LinkButton>--%>
                                        <div class="col-lg-12">
                                         <asp:Literal ID="ltr" Visible="false" runat="server"></asp:Literal>
