...
namespace Merchandising.BO_Digits.en
{
    public partial class AddEditAgreementSubCat : System.Web.UI.Page
    {
        ...
        {
            DataTable lstDatas = ObjclsFrms.loadList("SelectAgrSubCatByID", "sp_Masters", ResponseID.ToString());
        ...
        protected void Save()
        {
            ...
            if (ResponseID.Equals("") || ResponseID == 0)
            {
                ...
                string Value = ObjclsFrms.SaveData("sp_Masters", "InsertAgrSubCat", name.ToString(), arr);
            ...
            else
            {
                ...
                string Value = ObjclsFrms.SaveData("sp_Masters", "UpdateAgrSubCat", name.ToString(), arr);
                int res = Int32.Parse(Value.ToString());
                if (res > 0)
        ...
        {
            DataTable dt = ObjclsFrms.loadList("SelectAgrCatFromDrop", "sp_Masters");
