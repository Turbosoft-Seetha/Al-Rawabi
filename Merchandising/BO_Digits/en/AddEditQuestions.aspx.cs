    ...
    public partial class AddEditQuestions : System.Web.UI.Page
    {
        ...
        protected void fillForm()
        {
            ...
            else
            {
                ...
                lstData = Obj.loadList("SelectQuestionsByID", "sp_Cooler", ResponseID.ToString());
                if (lstData.Rows.Count > 0)
                {
                    string Question, Comments, Type, Number;

                    Question = lstData.Rows[0]["cqm_Question"].ToString();
                    Comments = lstData.Rows[0]["cqm_IsCommentsNeeded"].ToString();
                    Type = lstData.Rows[0]["qst_id"].ToString();
                    Number = lstData.Rows[0]["cqm_Number"].ToString();
        ...
        public void LoadData()
        {
            ...
            lstDatas = Obj.loadList("EditQuestions", "sp_Cooler", ResponseID.ToString());
        ...
        public void Delete(string Mode)
        {
            if (Mode.Equals("1"))
            {
                ...
                DataTable del = Obj.loadList("DeleteQD", "sp_Cooler", Ids.ToString());
        ...
        protected void Save()
        {
            ...
            if (ResponseID == 0)
            {
                ...
                DataTable lstClaim = Obj.loadList("AddQuestions", "sp_Cooler", Question.ToString(), arr);
            ...
            else
            {
                ...
                string Value = Obj.SaveData("sp_Cooler", "updateCooler", id.ToString(), arr);
        ...
        public void Route()
        {
            DataTable dt = Obj.loadList("selectQuestionType", "sp_Survey");
        ...
        {
            DataTable lstType = Obj.loadList("selectTypeByID", "sp_Cooler", txtType.SelectedValue.ToString());
