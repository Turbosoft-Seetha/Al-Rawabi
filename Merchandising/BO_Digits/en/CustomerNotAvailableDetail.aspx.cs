...
namespace Merchandising.BO_Digits.en
{
    public partial class CustomerNotAvailableDetail : System.Web.UI.Page
    {
        ...
        public void HeaderData()
        {
            ...
            lstDatas = ObjclsFrms.loadList("SelectCustomerNotAvailableHeader", "sp_Report", ResponseID.ToString());
        ...
        private void SpreadStreamProcessingForXLSXAndCSV(DataTable dt, SpreadDocumentFormat docFormat = SpreadDocumentFormat.Xlsx, string sheetName = "Sheet1")
        {
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                Response.AppendHeader("Content-Disposition", string.Format("attachment; filename={0}.{1}", "Customer Not Available Detail", "Xlsx"));
        ...
        public void ListData()
        {
            ...
            lstUser = ObjclsFrms.loadList("SelectCustomerNotAvailableDetail", "sp_Report", ResponseID.ToString(), arr);
