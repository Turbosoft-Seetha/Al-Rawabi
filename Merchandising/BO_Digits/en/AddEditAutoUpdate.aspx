<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="AddEditAutoUpdate.aspx.cs" Inherits="Merchandising.BO_Digits.en.AddEditAutoUpdate" %>
...
<asp:Content ID="ContentAction" ContentPlaceHolderID="Actions" runat="server">
    ...
    <telerik:RadAjaxPanel ID="rdd" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                                <asp:LinkButton ID="LinkButton1" Width="100px" runat="server" ValidationGroup="form" OnClick="LinkButton1_Click" UseSubmitBehavior="false" Text='<i class="icon-ok"></i>Proceed' 
