<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="Merchandising.BO_Digits.en.Dashboard" %>
            ...
            <div class="kt-portlet__head" style="padding: 0px; border-bottom: 0px;">
                <div class="kt-portlet__head-label row" style="padding-bottom: 20px;">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-3" style="padding-top: 10px;  top: 19px;">
                            <asp:LinkButton ID="lnkFilter" runat="server" CssClass="btn btn-sm btn-primary me-2" CausesValidation="true" OnClick="lnkFilter_Click">
                             ...
                             <asp:LinkButton ID="btnAdvancedFilter" runat="server" CssClass="btn btn-sm btn-primary me-2" BackColor="#DAE9F8" ForeColor="#009EF7" CausesValidation="true" OnClick="btnAdvancedFilter_Click">
                                                    Advanced Filter
                            </asp:LinkButton>
                        </div>
                            </div>
