<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="ListCustomerAssetTracking.aspx.cs" Inherits="Merchandising.BO_Digits.en.ListCustomerAssetTracking" %>
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="clm_Name" AllowFiltering="true" HeaderStyle-Width="120px"
                                             ...
                                             <telerik:GridTemplateColumn HeaderStyle-Width="100px" HeaderText="Image" UniqueName="Images" HeaderStyle-Font-Bold="true" AllowFiltering="false">
                                                <ItemTemplate>
                                                    <asp:HyperLink ID="salImg" runat="server" NavigateUrl=' <%# "../" +  Eval("cct_Image") %>' Target="_blank" Visible="true">
                                                        <asp:Image ID="salImage" runat="server" ImageUrl=' <%#  "../" +  Eval("cct_Image") %>' Height="20px" Width="20px" Visible="true" />
                                                    </asp:HyperLink>
                                                </ItemTemplate>
                                            </telerik:GridTemplateColumn>
