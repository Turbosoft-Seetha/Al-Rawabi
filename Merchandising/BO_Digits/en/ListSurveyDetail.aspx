<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="ListSurveyDetail.aspx.cs" Inherits="Merchandising.BO_Digits.en.ListSurveyDetail" %>
      ...
      <telerik:RadPanelBar RenderMode="Lightweight" CssClass="col-lg-12" Width="100%" ID="RadPanelBar0" runat="server">
                                <Items>
                                    <telerik:RadPanelItem Font-Bold="true" Expanded="false" BackColor="#F2F6F9">
                                        <ContentTemplate>
                                            <div class="kt-portlet__body mb-4" style="background-color: #F9FAFC; display: grid;">
                                                <table>
                                                    <td style="width: 56%">
