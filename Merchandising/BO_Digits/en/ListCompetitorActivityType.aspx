<%@ Page Title="" Language="C#" MasterPageFile="~/BO_Digits/en/en_master.Master" AutoEventWireup="true" CodeBehind="ListCompetitorActivityType.aspx.cs" Inherits="Merchandising.BO_Digits.en.ListCompetitorActivityType" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Actions" runat="server">
 ...
 <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btn btn-sm fw-bold btn-primary" Text="Add" OnClick="LinkButton1_Click" ></asp:LinkButton>
